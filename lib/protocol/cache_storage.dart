...
Future<void> deleteEntry(
  CacheId cacheId,  String request
) async {
 await _client.send('CacheStorage.deleteEntry', {'cacheId' : cacheId,'request' : request,});
}
...
var result =  await _client.send('CacheStorage.requestCacheNames', {'securityOrigin' : securityOrigin,});
return (result['caches'] as List).map((e) => Cache.fromJson(e as Map<String, dynamic>)).toList();
}
...
Future<CachedResponse> requestCachedResponse(
  CacheId cacheId,  String requestURL,  List<Header> requestHeaders
) async {
var result =  await _client.send('CacheStorage.requestCachedResponse', {'cacheId' : cacheId,'requestURL' : requestURL,'requestHeaders' : [...requestHeaders],});
...
var result =  await _client.send('CacheStorage.requestEntries', {'cacheId' : cacheId,'skipCount' : skipCount,'pageSize' : pageSize,if (pathFilter != null)'pathFilter' : pathFilter,});
...
RequestEntriesResult({required this.cacheDataEntries,required this.returnCount});

factory RequestEntriesResult.fromJson(Map<String, dynamic> json) {
return RequestEntriesResult(
cacheDataEntries:  (json['cacheDataEntries'] as List).map((e) => DataEntry.fromJson(e as Map<String, dynamic>)).toList(),
...
@override
bool operator ==(other) => (other is CacheId && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is CachedResponseType && other.value == value) || value == other;
...
DataEntry({required this.requestURL,required this.requestMethod,required this.requestHeaders,required this.responseTime,required this.responseStatus,required this.responseStatusText,required this.responseType,required this.responseHeaders});

factory DataEntry.fromJson(Map<String, dynamic> json) {
return DataEntry(
requestURL:  json['requestURL'] as String,
requestMethod:  json['requestMethod'] as String,
requestHeaders:  (json['requestHeaders'] as List).map((e) => Header.fromJson(e as Map<String, dynamic>)).toList(),
...
responseHeaders:  (json['responseHeaders'] as List).map((e) => Header.fromJson(e as Map<String, dynamic>)).toList(),
);
}
...
Cache({required this.cacheId,required this.securityOrigin,required this.cacheName});
