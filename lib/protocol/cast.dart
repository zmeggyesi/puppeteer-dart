...
Stream<List<Sink>> get onSinksUpdated => _client.onEvent.where((event) => event.name == 'Cast.sinksUpdated')
.map((event) => (event.parameters['sinks'] as List).map((e) => Sink.fromJson(e as Map<String, dynamic>)).toList())
;


  /// This is fired whenever the outstanding issue/error message changes.
  /// |issueMessage| is empty if there is no issue.
Stream<String> get onIssueUpdated => _client.onEvent.where((event) => event.name == 'Cast.issueUpdated')
...
{  String? presentationUrl}
 ...
 await _client.send('Cast.enable', {if (presentationUrl != null)'presentationUrl' : presentationUrl,});
}
