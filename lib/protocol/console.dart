...
Stream<ConsoleMessage> get onMessageAdded => _client.onEvent.where((event) => event.name == 'Console.messageAdded')
.map((event) => ConsoleMessage.fromJson(event.parameters['message'] as Map<String, dynamic>))
;
...
ConsoleMessage({required this.source,required this.level,required this.text,this.url,this.line,this.column});
...
@override
bool operator ==(other) => (other is ConsoleMessageSource && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is ConsoleMessageLevel && other.value == value) || value == other;
