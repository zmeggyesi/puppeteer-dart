...
CSSApi(this._client);
  ...
  /// web font
Stream<FontFace> get onFontsUpdated => _client.onEvent.where((event) => event.name == 'CSS.fontsUpdated')
.map((event) => FontFace.fromJson(event.parameters['font'] as Map<String, dynamic>))
;


  /// Fires whenever a MediaQuery result changes (for example, after a browser window has been
  /// resized.) The current implementation considers only viewport-dependent media features.
Stream get onMediaQueryResultChanged => _client.onEvent.where((event) => event.name == 'CSS.mediaQueryResultChanged')
;


  /// Fired whenever an active document stylesheet is added.
Stream<CSSStyleSheetHeader> get onStyleSheetAdded => _client.onEvent.where((event) => event.name == 'CSS.styleSheetAdded')
.map((event) => CSSStyleSheetHeader.fromJson(event.parameters['header'] as Map<String, dynamic>))
;


  /// Fired whenever a stylesheet is changed as a result of the client operation.
Stream<StyleSheetId> get onStyleSheetChanged => _client.onEvent.where((event) => event.name == 'CSS.styleSheetChanged')
.map((event) => StyleSheetId.fromJson(event.parameters['styleSheetId'] as String))
;


  /// Fired whenever an active document stylesheet is removed.
Stream<StyleSheetId> get onStyleSheetRemoved => _client.onEvent.where((event) => event.name == 'CSS.styleSheetRemoved')
.map((event) => StyleSheetId.fromJson(event.parameters['styleSheetId'] as String))
;
...
var result =  await _client.send('CSS.addRule', {'styleSheetId' : styleSheetId,'ruleText' : ruleText,'location' : location,});
...
var result =  await _client.send('CSS.collectClassNames', {'styleSheetId' : styleSheetId,});
...
var result =  await _client.send('CSS.createStyleSheet', {'frameId' : frameId,});
...
Future<void> forcePseudoState(
  dom.NodeId nodeId,  List<String> forcedPseudoClasses
) async {
 await _client.send('CSS.forcePseudoState', {'nodeId' : nodeId,'forcedPseudoClasses' : [...forcedPseudoClasses],});
}
...
var result =  await _client.send('CSS.getBackgroundColors', {'nodeId' : nodeId,});
...
var result =  await _client.send('CSS.getComputedStyleForNode', {'nodeId' : nodeId,});
return (result['computedStyle'] as List).map((e) => CSSComputedStyleProperty.fromJson(e as Map<String, dynamic>)).toList();
}
...
var result =  await _client.send('CSS.getInlineStylesForNode', {'nodeId' : nodeId,});
...
var result =  await _client.send('CSS.getMatchedStylesForNode', {'nodeId' : nodeId,});
return GetMatchedStylesForNodeResult.fromJson(result);
}

  /// Returns all media queries parsed by the rendering engine.
Future<List<CSSMedia>> getMediaQueries(

) async {
var result =  await _client.send('CSS.getMediaQueries');
return (result['medias'] as List).map((e) => CSSMedia.fromJson(e as Map<String, dynamic>)).toList();
}
...
var result =  await _client.send('CSS.getPlatformFontsForNode', {'nodeId' : nodeId,});
return (result['fonts'] as List).map((e) => PlatformFontUsage.fromJson(e as Map<String, dynamic>)).toList();
}
...
var result =  await _client.send('CSS.getStyleSheetText', {'styleSheetId' : styleSheetId,});
...
Future<void> setEffectivePropertyValueForNode(
 ...
 await _client.send('CSS.setEffectivePropertyValueForNode', {'nodeId' : nodeId,'propertyName' : propertyName,'value' : value,});
}

  /// Modifies the keyframe rule key text.
  /// Returns: The resulting key text after modification.
Future<Value> setKeyframeKey(
  StyleSheetId styleSheetId,  SourceRange range,  String keyText
) async {
var result =  await _client.send('CSS.setKeyframeKey', {'styleSheetId' : styleSheetId,'range' : range,'keyText' : keyText,});
...
Future<CSSMedia> setMediaText(
  StyleSheetId styleSheetId,  SourceRange range,  String text
) async {
var result =  await _client.send('CSS.setMediaText', {'styleSheetId' : styleSheetId,'range' : range,'text' : text,});
...
Future<SelectorList> setRuleSelector(
  StyleSheetId styleSheetId,  SourceRange range,  String selector
) async {
var result =  await _client.send('CSS.setRuleSelector', {'styleSheetId' : styleSheetId,'range' : range,'selector' : selector,});
return SelectorList.fromJson(result['selectorList'] as Map<String, dynamic>);
}

  /// Sets the new stylesheet text.
  /// Returns: URL of source map associated with script (if any).
Future<String> setStyleSheetText(
  StyleSheetId styleSheetId,  String text
) async {
var result =  await _client.send('CSS.setStyleSheetText', {'styleSheetId' : styleSheetId,'text' : text,});
...
var result =  await _client.send('CSS.setStyleTexts', {'edits' : [...edits],});
return (result['styles'] as List).map((e) => CSSStyle.fromJson(e as Map<String, dynamic>)).toList();
}

  /// Enables the selector recording.
Future<void> startRuleUsageTracking(
...
Future<List<RuleUsage>> stopRuleUsageTracking(

) async {
var result =  await _client.send('CSS.stopRuleUsageTracking');
return (result['ruleUsage'] as List).map((e) => RuleUsage.fromJson(e as Map<String, dynamic>)).toList();
}

  /// Obtain list of rules that became used since last call to this method (or since start of coverage
  /// instrumentation)
Future<List<RuleUsage>> takeCoverageDelta(

) async {
var result =  await _client.send('CSS.takeCoverageDelta');
return (result['coverage'] as List).map((e) => RuleUsage.fromJson(e as Map<String, dynamic>)).toList();
}
...
backgroundColors:  json.containsKey('backgroundColors') ? (json['backgroundColors'] as List).map((e) => e as String).toList() : null,
computedFontSize:  json.containsKey('computedFontSize') ? json['computedFontSize'] as String : null,
computedFontWeight:  json.containsKey('computedFontWeight') ? json['computedFontWeight'] as String : null,
);
}
}
...
inlineStyle:  json.containsKey('inlineStyle') ? CSSStyle.fromJson(json['inlineStyle'] as Map<String, dynamic>) : null,
attributesStyle:  json.containsKey('attributesStyle') ? CSSStyle.fromJson(json['attributesStyle'] as Map<String, dynamic>) : null,
);
}
}
...
GetMatchedStylesForNodeResult({this.inlineStyle,this.attributesStyle,this.matchedCSSRules,this.pseudoElements,this.inherited,this.cssKeyframesRules});

factory GetMatchedStylesForNodeResult.fromJson(Map<String, dynamic> json) {
return GetMatchedStylesForNodeResult(
inlineStyle:  json.containsKey('inlineStyle') ? CSSStyle.fromJson(json['inlineStyle'] as Map<String, dynamic>) : null,
attributesStyle:  json.containsKey('attributesStyle') ? CSSStyle.fromJson(json['attributesStyle'] as Map<String, dynamic>) : null,
matchedCSSRules:  json.containsKey('matchedCSSRules') ? (json['matchedCSSRules'] as List).map((e) => RuleMatch.fromJson(e as Map<String, dynamic>)).toList() : null,
pseudoElements:  json.containsKey('pseudoElements') ? (json['pseudoElements'] as List).map((e) => PseudoElementMatches.fromJson(e as Map<String, dynamic>)).toList() : null,
inherited:  json.containsKey('inherited') ? (json['inherited'] as List).map((e) => InheritedStyleEntry.fromJson(e as Map<String, dynamic>)).toList() : null,
cssKeyframesRules:  json.containsKey('cssKeyframesRules') ? (json['cssKeyframesRules'] as List).map((e) => CSSKeyframesRule.fromJson(e as Map<String, dynamic>)).toList() : null,
);
}
}
...
@override
bool operator ==(other) => (other is StyleSheetId && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is StyleSheetOrigin && other.value == value) || value == other;
...
matches:  (json['matches'] as List).map((e) => RuleMatch.fromJson(e as Map<String, dynamic>)).toList(),
);
}
...
inlineStyle:  json.containsKey('inlineStyle') ? CSSStyle.fromJson(json['inlineStyle'] as Map<String, dynamic>) : null,
matchedCSSRules:  (json['matchedCSSRules'] as List).map((e) => RuleMatch.fromJson(e as Map<String, dynamic>)).toList(),
);
}
...
if (inlineStyle != null) 
'inlineStyle' : inlineStyle.toJson(),
};}
}
...
matchingSelectors:  (json['matchingSelectors'] as List).map((e) => e as int).toList(),
);
}
...
range:  json.containsKey('range') ? SourceRange.fromJson(json['range'] as Map<String, dynamic>) : null,
);
}
...
return SelectorList(
selectors:  (json['selectors'] as List).map((e) => Value.fromJson(e as Map<String, dynamic>)).toList(),
text:  json['text'] as String,
);
}
...
CSSStyleSheetHeader({required this.styleSheetId,required this.frameId,required this.sourceURL,this.sourceMapURL,required this.origin,required this.title,this.ownerNode,required this.disabled,this.hasSourceURL,required this.isInline,required this.startLine,required this.startColumn,required this.length});
...
ownerNode:  json.containsKey('ownerNode') ? dom.BackendNodeId.fromJson(json['ownerNode'] as int) : null,
...
CSSRule({this.styleSheetId,required this.selectorList,required this.origin,required this.style,this.media});

factory CSSRule.fromJson(Map<String, dynamic> json) {
return CSSRule(
styleSheetId:  json.containsKey('styleSheetId') ? StyleSheetId.fromJson(json['styleSheetId'] as String) : null,
selectorList:  SelectorList.fromJson(json['selectorList'] as Map<String, dynamic>),
origin:  StyleSheetOrigin.fromJson(json['origin'] as String),
style:  CSSStyle.fromJson(json['style'] as Map<String, dynamic>),
media:  json.containsKey('media') ? (json['media'] as List).map((e) => CSSMedia.fromJson(e as Map<String, dynamic>)).toList() : null,
);
}
...
RuleUsage({required this.styleSheetId,required this.startOffset,required this.endOffset,required this.used});
...
SourceRange({required this.startLine,required this.startColumn,required this.endLine,required this.endColumn});
...
important:  json.containsKey('important') ? json['important'] as bool : null,
);
}
...
CSSStyle({this.styleSheetId,required this.cssProperties,required this.shorthandEntries,this.cssText,this.range});

factory CSSStyle.fromJson(Map<String, dynamic> json) {
return CSSStyle(
styleSheetId:  json.containsKey('styleSheetId') ? StyleSheetId.fromJson(json['styleSheetId'] as String) : null,
cssProperties:  (json['cssProperties'] as List).map((e) => CSSProperty.fromJson(e as Map<String, dynamic>)).toList(),
shorthandEntries:  (json['shorthandEntries'] as List).map((e) => ShorthandEntry.fromJson(e as Map<String, dynamic>)).toList(),
...
CSSProperty({required this.name,required this.value,this.important,this.implicit,this.text,this.parsedOk,this.disabled,this.range});
...
CSSMedia({required this.text,required this.source,this.sourceURL,this.range,this.styleSheetId,this.mediaList});

factory CSSMedia.fromJson(Map<String, dynamic> json) {
return CSSMedia(
text:  json['text'] as String,
source:  CSSMediaSource.fromJson(json['source'] as String),
sourceURL:  json.containsKey('sourceURL') ? json['sourceURL'] as String : null,
range:  json.containsKey('range') ? SourceRange.fromJson(json['range'] as Map<String, dynamic>) : null,
styleSheetId:  json.containsKey('styleSheetId') ? StyleSheetId.fromJson(json['styleSheetId'] as String) : null,
mediaList:  json.containsKey('mediaList') ? (json['mediaList'] as List).map((e) => MediaQuery.fromJson(e as Map<String, dynamic>)).toList() : null,
);
}
...
@override
bool operator ==(other) => (other is CSSMediaSource && other.value == value) || value == other;
...
return MediaQuery(
expressions:  (json['expressions'] as List).map((e) => MediaQueryExpression.fromJson(e as Map<String, dynamic>)).toList(),
...
MediaQueryExpression({required this.value,required this.unit,required this.feature,this.valueRange,this.computedLength});
...
valueRange:  json.containsKey('valueRange') ? SourceRange.fromJson(json['valueRange'] as Map<String, dynamic>) : null,
computedLength:  json.containsKey('computedLength') ? json['computedLength'] as num : null,
);
}
...
PlatformFontUsage({required this.familyName,required this.isCustomFont,required this.glyphCount});
...
FontFace({required this.fontFamily,required this.fontStyle,required this.fontVariant,required this.fontWeight,required this.fontStretch,required this.unicodeRange,required this.src,required this.platformFontFamily});
...
animationName:  Value.fromJson(json['animationName'] as Map<String, dynamic>),
keyframes:  (json['keyframes'] as List).map((e) => CSSKeyframeRule.fromJson(e as Map<String, dynamic>)).toList(),
);
}
...
CSSKeyframeRule({this.styleSheetId,required this.origin,required this.keyText,required this.style});
...
StyleDeclarationEdit({required this.styleSheetId,required this.range,required this.text});
