...
Stream<BreakpointResolvedEvent> get onBreakpointResolved => _client.onEvent.where((event) => event.name == 'Debugger.breakpointResolved')
.map((event) => BreakpointResolvedEvent.fromJson(event.parameters))
;


  /// Fired when the virtual machine stopped on breakpoint or exception or any other stop criteria.
Stream<PausedEvent> get onPaused => _client.onEvent.where((event) => event.name == 'Debugger.paused')
.map((event) => PausedEvent.fromJson(event.parameters))
;


  /// Fired when the virtual machine resumed execution.
Stream get onResumed => _client.onEvent.where((event) => event.name == 'Debugger.resumed')
;


  /// Fired when virtual machine fails to parse the script.
Stream<ScriptFailedToParseEvent> get onScriptFailedToParse => _client.onEvent.where((event) => event.name == 'Debugger.scriptFailedToParse')
...
Stream<ScriptParsedEvent> get onScriptParsed => _client.onEvent.where((event) => event.name == 'Debugger.scriptParsed')
...
assert(targetCallFrames == null ||  const ['any', 'current'].contains(targetCallFrames));
 await _client.send('Debugger.continueToLocation', {'location' : location,if (targetCallFrames != null)'targetCallFrames' : targetCallFrames,});
}
...
Future<runtime.UniqueDebuggerId> enable(

{  num? maxScriptsCacheSize}
) async {
var result =  await _client.send('Debugger.enable', {if (maxScriptsCacheSize != null)'maxScriptsCacheSize' : maxScriptsCacheSize,});
...
,
{  String? objectGroup,  bool? includeCommandLineAPI,  bool? silent,  bool? returnByValue,  bool? generatePreview,  bool? throwOnSideEffect,  runtime.TimeDelta? timeout}
) async {
var result =  await _client.send('Debugger.evaluateOnCallFrame', {'callFrameId' : callFrameId,'expression' : expression,if (objectGroup != null)'objectGroup' : objectGroup,if (includeCommandLineAPI != null)'includeCommandLineAPI' : includeCommandLineAPI,if (silent != null)'silent' : silent,if (returnByValue != null)'returnByValue' : returnByValue,if (generatePreview != null)'generatePreview' : generatePreview,if (throwOnSideEffect != null)'throwOnSideEffect' : throwOnSideEffect,if (timeout != null)'timeout' : timeout,});
...
Future<List<BreakLocation>> getPossibleBreakpoints(
  Location start
,
{  Location? end,  bool? restrictToFunction}
) async {
var result =  await _client.send('Debugger.getPossibleBreakpoints', {'start' : start,if (end != null)'end' : end,if (restrictToFunction != null)'restrictToFunction' : restrictToFunction,});
return (result['locations'] as List).map((e) => BreakLocation.fromJson(e as Map<String, dynamic>)).toList();
}
...
var result =  await _client.send('Debugger.getScriptSource', {'scriptId' : scriptId,});
...
var result =  await _client.send('Debugger.getStackTrace', {'stackTraceId' : stackTraceId,});
return runtime.StackTraceData.fromJson(result['stackTrace'] as Map<String, dynamic>);
}
...
Future<void> pauseOnAsyncCall(
 ...
 await _client.send('Debugger.pauseOnAsyncCall', {'parentStackTraceId' : parentStackTraceId,});
}
...
Future<void> removeBreakpoint(
 ...
 await _client.send('Debugger.removeBreakpoint', {'breakpointId' : breakpointId,});
}
...
var result =  await _client.send('Debugger.restartFrame', {'callFrameId' : callFrameId,});
...
var result =  await _client.send('Debugger.searchInContent', {'scriptId' : scriptId,'query' : query,if (caseSensitive != null)'caseSensitive' : caseSensitive,if (isRegex != null)'isRegex' : isRegex,});
return (result['result'] as List).map((e) => SearchMatch.fromJson(e as Map<String, dynamic>)).toList();
}
...
Future<void> setAsyncCallStackDepth(
 ...
 await _client.send('Debugger.setAsyncCallStackDepth', {'maxDepth' : maxDepth,});
}
...
Future<void> setBlackboxPatterns(
 ...
 await _client.send('Debugger.setBlackboxPatterns', {'patterns' : [...patterns],});
}
...
Future<void> setBlackboxedRanges(
  runtime.ScriptId scriptId,  List<ScriptPosition> positions
) async {
 await _client.send('Debugger.setBlackboxedRanges', {'scriptId' : scriptId,'positions' : [...positions],});
}
...
var result =  await _client.send('Debugger.setBreakpoint', {'location' : location,if (condition != null)'condition' : condition,});
...
@Enum(['beforeScriptExecution', 'beforeScriptWithSourceMapExecution'])  String instrumentation
) async {
assert( const ['beforeScriptExecution', 'beforeScriptWithSourceMapExecution'].contains(instrumentation));
var result =  await _client.send('Debugger.setInstrumentationBreakpoint', {'instrumentation' : instrumentation,});
...
Future<SetBreakpointByUrlResult> setBreakpointByUrl(
  int lineNumber
,
{  String? url,  String? urlRegex,  String? scriptHash,  int? columnNumber,  String? condition}
) async {
var result =  await _client.send('Debugger.setBreakpointByUrl', {'lineNumber' : lineNumber,if (url != null)'url' : url,if (urlRegex != null)'urlRegex' : urlRegex,if (scriptHash != null)'scriptHash' : scriptHash,if (columnNumber != null)'columnNumber' : columnNumber,if (condition != null)'condition' : condition,});
...
var result =  await _client.send('Debugger.setBreakpointOnFunctionCall', {'objectId' : objectId,if (condition != null)'condition' : condition,});
return BreakpointId.fromJson(result['breakpointId'] as String);
}
...
@Enum(['none', 'uncaught', 'all'])  String state
) async {
...
var result =  await _client.send('Debugger.setScriptSource', {'scriptId' : scriptId,'scriptSource' : scriptSource,if (dryRun != null)'dryRun' : dryRun,});
return SetScriptSourceResult.fromJson(result);
}

  /// Makes page not interrupt on any pauses (breakpoint, exception, dom exception etc).
  /// [skip] New value for skip pauses state.
Future<void> setSkipAllPauses(
  bool skip
) async {
...
Future<void> setVariableValue(
  int scopeNumber,  String variableName,  runtime.CallArgument newValue,  CallFrameId callFrameId
) async {
 await _client.send('Debugger.setVariableValue', {'scopeNumber' : scopeNumber,'variableName' : variableName,'newValue' : newValue,'callFrameId' : callFrameId,});
}
...
{  bool? breakOnAsyncCall}
 ...
 await _client.send('Debugger.stepInto', {if (breakOnAsyncCall != null)'breakOnAsyncCall' : breakOnAsyncCall,});
}
...
PausedEvent({required this.callFrames,required this.reason,this.data,this.hitBreakpoints,this.asyncStackTrace,this.asyncStackTraceId,this.asyncCallStackTraceId});
...
hitBreakpoints:  json.containsKey('hitBreakpoints') ? (json['hitBreakpoints'] as List).map((e) => e as String).toList() : null,
asyncStackTrace:  json.containsKey('asyncStackTrace') ? runtime.StackTraceData.fromJson(json['asyncStackTrace'] as Map<String, dynamic>) : null,
asyncStackTraceId:  json.containsKey('asyncStackTraceId') ? runtime.StackTraceId.fromJson(json['asyncStackTraceId'] as Map<String, dynamic>) : null,
asyncCallStackTraceId:  json.containsKey('asyncCallStackTraceId') ? runtime.StackTraceId.fromJson(json['asyncCallStackTraceId'] as Map<String, dynamic>) : null,
);
}
}
...
ScriptFailedToParseEvent({required this.scriptId,required this.url,required this.startLine,required this.startColumn,required this.endLine,required this.endColumn,required this.executionContextId,required this.hash,this.executionContextAuxData,this.sourceMapURL,this.hasSourceURL,this.isModule,this.length,this.stackTrace});
...
executionContextId:  runtime.ExecutionContextId.fromJson(json['executionContextId'] as int),
hash:  json['hash'] as String,
executionContextAuxData:  json.containsKey('executionContextAuxData') ? json['executionContextAuxData'] as Map<String, dynamic> : null,
sourceMapURL:  json.containsKey('sourceMapURL') ? json['sourceMapURL'] as String : null,
hasSourceURL:  json.containsKey('hasSourceURL') ? json['hasSourceURL'] as bool : null,
isModule:  json.containsKey('isModule') ? json['isModule'] as bool : null,
length:  json.containsKey('length') ? json['length'] as int : null,
stackTrace:  json.containsKey('stackTrace') ? runtime.StackTraceData.fromJson(json['stackTrace'] as Map<String, dynamic>) : null,
);
}
}
...
ScriptParsedEvent({required this.scriptId,required this.url,required this.startLine,required this.startColumn,required this.endLine,required this.endColumn,required this.executionContextId,required this.hash,this.executionContextAuxData,this.isLiveEdit,this.sourceMapURL,this.hasSourceURL,this.isModule,this.length,this.stackTrace});
...
hash:  json['hash'] as String,
executionContextAuxData:  json.containsKey('executionContextAuxData') ? json['executionContextAuxData'] as Map<String, dynamic> : null,
isLiveEdit:  json.containsKey('isLiveEdit') ? json['isLiveEdit'] as bool : null,
sourceMapURL:  json.containsKey('sourceMapURL') ? json['sourceMapURL'] as String : null,
hasSourceURL:  json.containsKey('hasSourceURL') ? json['hasSourceURL'] as bool : null,
isModule:  json.containsKey('isModule') ? json['isModule'] as bool : null,
length:  json.containsKey('length') ? json['length'] as int : null,
...
result:  runtime.RemoteObject.fromJson(json['result'] as Map<String, dynamic>),
exceptionDetails:  json.containsKey('exceptionDetails') ? runtime.ExceptionDetails.fromJson(json['exceptionDetails'] as Map<String, dynamic>) : null,
);
}
}
...
RestartFrameResult({required this.callFrames,this.asyncStackTrace,this.asyncStackTraceId});
...
SetBreakpointResult({required this.breakpointId,required this.actualLocation});

factory SetBreakpointResult.fromJson(Map<String, dynamic> json) {
return SetBreakpointResult(
breakpointId:  BreakpointId.fromJson(json['breakpointId'] as String),
actualLocation:  Location.fromJson(json['actualLocation'] as Map<String, dynamic>),
);
}
}
...
SetBreakpointByUrlResult({required this.breakpointId,required this.locations});

factory SetBreakpointByUrlResult.fromJson(Map<String, dynamic> json) {
return SetBreakpointByUrlResult(
breakpointId:  BreakpointId.fromJson(json['breakpointId'] as String),
locations:  (json['locations'] as List).map((e) => Location.fromJson(e as Map<String, dynamic>)).toList(),
);
}
}
...
SetScriptSourceResult({this.callFrames,this.stackChanged,this.asyncStackTrace,this.asyncStackTraceId,this.exceptionDetails});

factory SetScriptSourceResult.fromJson(Map<String, dynamic> json) {
return SetScriptSourceResult(
callFrames:  json.containsKey('callFrames') ? (json['callFrames'] as List).map((e) => CallFrame.fromJson(e as Map<String, dynamic>)).toList() : null,
stackChanged:  json.containsKey('stackChanged') ? json['stackChanged'] as bool : null,
asyncStackTrace:  json.containsKey('asyncStackTrace') ? runtime.StackTraceData.fromJson(json['asyncStackTrace'] as Map<String, dynamic>) : null,
asyncStackTraceId:  json.containsKey('asyncStackTraceId') ? runtime.StackTraceId.fromJson(json['asyncStackTraceId'] as Map<String, dynamic>) : null,
exceptionDetails:  json.containsKey('exceptionDetails') ? runtime.ExceptionDetails.fromJson(json['exceptionDetails'] as Map<String, dynamic>) : null,
);
...
@override
bool operator ==(other) => (other is BreakpointId && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is CallFrameId && other.value == value) || value == other;
...
Location({required this.scriptId,required this.lineNumber,this.columnNumber});

factory Location.fromJson(Map<String, dynamic> json) {
return Location(
scriptId:  runtime.ScriptId.fromJson(json['scriptId'] as String),
lineNumber:  json['lineNumber'] as int,
columnNumber:  json.containsKey('columnNumber') ? json['columnNumber'] as int : null,
);
}
...
CallFrame({required this.callFrameId,required this.functionName,this.functionLocation,required this.location,required this.url,required this.scopeChain,required this.this$,this.returnValue});

factory CallFrame.fromJson(Map<String, dynamic> json) {
return CallFrame(
callFrameId:  CallFrameId.fromJson(json['callFrameId'] as String),
functionName:  json['functionName'] as String,
functionLocation:  json.containsKey('functionLocation') ? Location.fromJson(json['functionLocation'] as Map<String, dynamic>) : null,
location:  Location.fromJson(json['location'] as Map<String, dynamic>),
url:  json['url'] as String,
scopeChain:  (json['scopeChain'] as List).map((e) => Scope.fromJson(e as Map<String, dynamic>)).toList(),
this$:  runtime.RemoteObject.fromJson(json['this'] as Map<String, dynamic>),
returnValue:  json.containsKey('returnValue') ? runtime.RemoteObject.fromJson(json['returnValue'] as Map<String, dynamic>) : null,
);
}
...
Scope({required this.type,required this.object,this.name,this.startLocation,this.endLocation});

factory Scope.fromJson(Map<String, dynamic> json) {
return Scope(
type:  ScopeType.fromJson(json['type'] as String),
object:  runtime.RemoteObject.fromJson(json['object'] as Map<String, dynamic>),
name:  json.containsKey('name') ? json['name'] as String : null,
startLocation:  json.containsKey('startLocation') ? Location.fromJson(json['startLocation'] as Map<String, dynamic>) : null,
endLocation:  json.containsKey('endLocation') ? Location.fromJson(json['endLocation'] as Map<String, dynamic>) : null,
);
}
...
@override
bool operator ==(other) => (other is ScopeType && other.value == value) || value == other;
...
BreakLocation({required this.scriptId,required this.lineNumber,this.columnNumber,this.type});
...
lineNumber:  json['lineNumber'] as int,
columnNumber:  json.containsKey('columnNumber') ? json['columnNumber'] as int : null,
type:  json.containsKey('type') ? BreakLocationType.fromJson(json['type'] as String) : null,
);
}
...
@override
bool operator ==(other) => (other is BreakLocationType && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is PausedEventReason && other.value == value) || value == other;
