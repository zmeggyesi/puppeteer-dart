...
AccessibilityApi get accessibility =>  _accessibility ??= AccessibilityApi(client);
...
ApplicationCacheApi get applicationCache =>  _applicationCache ??= ApplicationCacheApi(client);
...
BackgroundServiceApi get backgroundService =>  _backgroundService ??= BackgroundServiceApi(client);
...
DeviceOrientationApi get deviceOrientation =>  _deviceOrientation ??= DeviceOrientationApi(client);
...
HeadlessExperimentalApi get headlessExperimental =>  _headlessExperimental ??= HeadlessExperimentalApi(client);
...
ServiceWorkerApi get serviceWorker =>  _serviceWorker ??= ServiceWorkerApi(client);
