...
Stream<AttributeModifiedEvent> get onAttributeModified => _client.onEvent.where((event) => event.name == 'DOM.attributeModified')
.map((event) => AttributeModifiedEvent.fromJson(event.parameters))
;


  /// Fired when `Element`'s attribute is removed.
Stream<AttributeRemovedEvent> get onAttributeRemoved => _client.onEvent.where((event) => event.name == 'DOM.attributeRemoved')
.map((event) => AttributeRemovedEvent.fromJson(event.parameters))
;


  /// Mirrors `DOMCharacterDataModified` event.
Stream<CharacterDataModifiedEvent> get onCharacterDataModified => _client.onEvent.where((event) => event.name == 'DOM.characterDataModified')
.map((event) => CharacterDataModifiedEvent.fromJson(event.parameters))
;


  /// Fired when `Container`'s child node count has changed.
Stream<ChildNodeCountUpdatedEvent> get onChildNodeCountUpdated => _client.onEvent.where((event) => event.name == 'DOM.childNodeCountUpdated')
.map((event) => ChildNodeCountUpdatedEvent.fromJson(event.parameters))
;


  /// Mirrors `DOMNodeInserted` event.
Stream<ChildNodeInsertedEvent> get onChildNodeInserted => _client.onEvent.where((event) => event.name == 'DOM.childNodeInserted')
.map((event) => ChildNodeInsertedEvent.fromJson(event.parameters))
;


  /// Mirrors `DOMNodeRemoved` event.
Stream<ChildNodeRemovedEvent> get onChildNodeRemoved => _client.onEvent.where((event) => event.name == 'DOM.childNodeRemoved')
.map((event) => ChildNodeRemovedEvent.fromJson(event.parameters))
;


  /// Called when distrubution is changed.
Stream<DistributedNodesUpdatedEvent> get onDistributedNodesUpdated => _client.onEvent.where((event) => event.name == 'DOM.distributedNodesUpdated')
.map((event) => DistributedNodesUpdatedEvent.fromJson(event.parameters))
;


  /// Fired when `Document` has been totally updated. Node ids are no longer valid.
Stream get onDocumentUpdated => _client.onEvent.where((event) => event.name == 'DOM.documentUpdated')
;


  /// Fired when `Element`'s inline style is modified via a CSS property modification.
Stream<List<NodeId>> get onInlineStyleInvalidated => _client.onEvent.where((event) => event.name == 'DOM.inlineStyleInvalidated')
.map((event) => (event.parameters['nodeIds'] as List).map((e) => NodeId.fromJson(e as int)).toList())
;


  /// Called when a pseudo element is added to an element.
Stream<PseudoElementAddedEvent> get onPseudoElementAdded => _client.onEvent.where((event) => event.name == 'DOM.pseudoElementAdded')
.map((event) => PseudoElementAddedEvent.fromJson(event.parameters))
;


  /// Called when a pseudo element is removed from an element.
Stream<PseudoElementRemovedEvent> get onPseudoElementRemoved => _client.onEvent.where((event) => event.name == 'DOM.pseudoElementRemoved')
...
Stream<SetChildNodesEvent> get onSetChildNodes => _client.onEvent.where((event) => event.name == 'DOM.setChildNodes')
.map((event) => SetChildNodesEvent.fromJson(event.parameters))
;


  /// Called when shadow root is popped from the element.
Stream<ShadowRootPoppedEvent> get onShadowRootPopped => _client.onEvent.where((event) => event.name == 'DOM.shadowRootPopped')
.map((event) => ShadowRootPoppedEvent.fromJson(event.parameters))
;


  /// Called when shadow root is pushed into the element.
Stream<ShadowRootPushedEvent> get onShadowRootPushed => _client.onEvent.where((event) => event.name == 'DOM.shadowRootPushed')
...
var result =  await _client.send('DOM.collectClassNamesFromSubtree', {'nodeId' : nodeId,});
...
Future<NodeId> copyTo(
  NodeId nodeId,  NodeId targetNodeId
,
{  NodeId? insertBeforeNodeId}
) async {
var result =  await _client.send('DOM.copyTo', {'nodeId' : nodeId,'targetNodeId' : targetNodeId,if (insertBeforeNodeId != null)'insertBeforeNodeId' : insertBeforeNodeId,});
...
{  NodeId? nodeId,  BackendNodeId? backendNodeId,  runtime.RemoteObjectId? objectId,  int? depth,  bool? pierce}
) async {
var result =  await _client.send('DOM.describeNode', {if (nodeId != null)'nodeId' : nodeId,if (backendNodeId != null)'backendNodeId' : backendNodeId,if (objectId != null)'objectId' : objectId,if (depth != null)'depth' : depth,if (pierce != null)'pierce' : pierce,});
...
Future<void> discardSearchResults(
  String searchId
) async {
 await _client.send('DOM.discardSearchResults', {'searchId' : searchId,});
}
...
{  NodeId? nodeId,  BackendNodeId? backendNodeId,  runtime.RemoteObjectId? objectId}
) async {
 await _client.send('DOM.focus', {if (nodeId != null)'nodeId' : nodeId,if (backendNodeId != null)'backendNodeId' : backendNodeId,if (objectId != null)'objectId' : objectId,});
}
...
var result =  await _client.send('DOM.getAttributes', {'nodeId' : nodeId,});
...
var result =  await _client.send('DOM.getBoxModel', {if (nodeId != null)'nodeId' : nodeId,if (backendNodeId != null)'backendNodeId' : backendNodeId,if (objectId != null)'objectId' : objectId,});
...
var result =  await _client.send('DOM.getContentQuads', {if (nodeId != null)'nodeId' : nodeId,if (backendNodeId != null)'backendNodeId' : backendNodeId,if (objectId != null)'objectId' : objectId,});
return (result['quads'] as List).map((e) => Quad.fromJson(e as List<num>)).toList();
}
...
var result =  await _client.send('DOM.getDocument', {if (depth != null)'depth' : depth,if (pierce != null)'pierce' : pierce,});
...
var result =  await _client.send('DOM.getFlattenedDocument', {if (depth != null)'depth' : depth,if (pierce != null)'pierce' : pierce,});
return (result['nodes'] as List).map((e) => Node.fromJson(e as Map<String, dynamic>)).toList();
}
...
Future<GetNodeForLocationResult> getNodeForLocation(
  int x,  int y
,
{  bool? includeUserAgentShadowDOM}
) async {
var result =  await _client.send('DOM.getNodeForLocation', {'x' : x,'y' : y,if (includeUserAgentShadowDOM != null)'includeUserAgentShadowDOM' : includeUserAgentShadowDOM,});
...
var result =  await _client.send('DOM.getOuterHTML', {if (nodeId != null)'nodeId' : nodeId,if (backendNodeId != null)'backendNodeId' : backendNodeId,if (objectId != null)'objectId' : objectId,});
...
var result =  await _client.send('DOM.getRelayoutBoundary', {'nodeId' : nodeId,});
return NodeId.fromJson(result['nodeId'] as int);
}
...
var result =  await _client.send('DOM.getSearchResults', {'searchId' : searchId,'fromIndex' : fromIndex,'toIndex' : toIndex,});
return (result['nodeIds'] as List).map((e) => NodeId.fromJson(e as int)).toList();
}
...
var result =  await _client.send('DOM.moveTo', {'nodeId' : nodeId,'targetNodeId' : targetNodeId,if (insertBeforeNodeId != null)'insertBeforeNodeId' : insertBeforeNodeId,});
return NodeId.fromJson(result['nodeId'] as int);
}
...
var result =  await _client.send('DOM.performSearch', {'query' : query,if (includeUserAgentShadowDOM != null)'includeUserAgentShadowDOM' : includeUserAgentShadowDOM,});
...
var result =  await _client.send('DOM.pushNodeByPathToFrontend', {'path' : path,});
return NodeId.fromJson(result['nodeId'] as int);
}
...
var result =  await _client.send('DOM.pushNodesByBackendIdsToFrontend', {'backendNodeIds' : [...backendNodeIds],});
return (result['nodeIds'] as List).map((e) => NodeId.fromJson(e as int)).toList();
}
...
Future<NodeId> querySelector(
  NodeId nodeId,  String selector
) async {
var result =  await _client.send('DOM.querySelector', {'nodeId' : nodeId,'selector' : selector,});
return NodeId.fromJson(result['nodeId'] as int);
}
...
var result =  await _client.send('DOM.querySelectorAll', {'nodeId' : nodeId,'selector' : selector,});
return (result['nodeIds'] as List).map((e) => NodeId.fromJson(e as int)).toList();
}
...
Future<void> removeAttribute(
 ...
 await _client.send('DOM.removeAttribute', {'nodeId' : nodeId,'name' : name,});
}
...
Future<void> removeNode(
 ...
 await _client.send('DOM.removeNode', {'nodeId' : nodeId,});
}
...
{  int? depth,  bool? pierce}
 ...
 await _client.send('DOM.requestChildNodes', {'nodeId' : nodeId,if (depth != null)'depth' : depth,if (pierce != null)'pierce' : pierce,});
}
...
var result =  await _client.send('DOM.requestNode', {'objectId' : objectId,});
return NodeId.fromJson(result['nodeId'] as int);
}
...
{  NodeId? nodeId,  dom.BackendNodeId? backendNodeId,  String? objectGroup,  runtime.ExecutionContextId? executionContextId}
) async {
var result =  await _client.send('DOM.resolveNode', {if (nodeId != null)'nodeId' : nodeId,if (backendNodeId != null)'backendNodeId' : backendNodeId,if (objectGroup != null)'objectGroup' : objectGroup,if (executionContextId != null)'executionContextId' : executionContextId,});
return runtime.RemoteObject.fromJson(result['object'] as Map<String, dynamic>);
}
...
Future<void> setAttributeValue(
  NodeId nodeId,  String name,  String value
) async {
 await _client.send('DOM.setAttributeValue', {'nodeId' : nodeId,'name' : name,'value' : value,});
}
...
Future<void> setAttributesAsText(
  NodeId nodeId,  String text
,
{  String? name}
) async {
 await _client.send('DOM.setAttributesAsText', {'nodeId' : nodeId,'text' : text,if (name != null)'name' : name,});
}
  ...
  /// [backendNodeId] Identifier of the backend node.
  /// [objectId] JavaScript object id of the node wrapper.
Future<void> setFileInputFiles(
  List<String> files
,
{  NodeId? nodeId,  BackendNodeId? backendNodeId,  runtime.RemoteObjectId? objectId}
) async {
 await _client.send('DOM.setFileInputFiles', {'files' : [...files],if (nodeId != null)'nodeId' : nodeId,if (backendNodeId != null)'backendNodeId' : backendNodeId,if (objectId != null)'objectId' : objectId,});
}

  /// Sets if stack traces should be captured for Nodes. See `Node.getNodeStackTraces`. Default is disabled.
  /// [enable] Enable or disable.
Future<void> setNodeStackTracesEnabled(
  bool enable
) async {
 await _client.send('DOM.setNodeStackTracesEnabled', {'enable' : enable,});
}

  /// Gets stack traces associated with a Node. As of now, only provides stack trace for Node creation.
  /// [nodeId] Id of the node to get stack traces for.
  /// Returns: Creation stack trace, if available.
Future<runtime.StackTraceData> getNodeStackTraces(
  NodeId nodeId
) async {
var result =  await _client.send('DOM.getNodeStackTraces', {'nodeId' : nodeId,});
return runtime.StackTraceData.fromJson(result['creation'] as Map<String, dynamic>);
}

  /// Returns file information for the given
  /// File wrapper.
  /// [objectId] JavaScript object id of the node wrapper.
Future<String> getFileInfo(
  runtime.RemoteObjectId objectId
) async {
var result =  await _client.send('DOM.getFileInfo', {'objectId' : objectId,});
...
Future<void> setInspectedNode(
  NodeId nodeId
) async {
 await _client.send('DOM.setInspectedNode', {'nodeId' : nodeId,});
}
...
var result =  await _client.send('DOM.setNodeName', {'nodeId' : nodeId,'name' : name,});
return NodeId.fromJson(result['nodeId'] as int);
}
...
Future<void> setNodeValue(
  NodeId nodeId,  String value
) async {
 await _client.send('DOM.setNodeValue', {'nodeId' : nodeId,'value' : value,});
}

  /// Sets node HTML markup, returns new node id.
  /// [nodeId] Id of the node to set markup for.
  /// [outerHTML] Outer HTML markup to set.
Future<void> setOuterHTML(
  NodeId nodeId,  String outerHTML
) async {
 await _client.send('DOM.setOuterHTML', {'nodeId' : nodeId,'outerHTML' : outerHTML,});
}
...
CharacterDataModifiedEvent({required this.nodeId,required this.characterData});
...
ChildNodeCountUpdatedEvent({required this.nodeId,required this.childNodeCount});
...
ChildNodeInsertedEvent({required this.parentNodeId,required this.previousNodeId,required this.node});
...
DistributedNodesUpdatedEvent({required this.insertionPointId,required this.distributedNodes});
...
distributedNodes:  (json['distributedNodes'] as List).map((e) => BackendNode.fromJson(e as Map<String, dynamic>)).toList(),
);
}
}
...
PseudoElementAddedEvent({required this.parentId,required this.pseudoElement});
...
pseudoElement:  Node.fromJson(json['pseudoElement'] as Map<String, dynamic>),
);
}
}
...
PseudoElementRemovedEvent({required this.parentId,required this.pseudoElementId});
...
parentId:  NodeId.fromJson(json['parentId'] as int),
nodes:  (json['nodes'] as List).map((e) => Node.fromJson(e as Map<String, dynamic>)).toList(),
);
}
}
...
nodeId:  json.containsKey('nodeId') ? NodeId.fromJson(json['nodeId'] as int) : null,
);
}
}
...
@override
bool operator ==(other) => (other is NodeId && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is BackendNodeId && other.value == value) || value == other;
...
BackendNode({required this.nodeType,required this.nodeName,required this.backendNodeId});
...
@override
bool operator ==(other) => (other is PseudoType && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is ShadowRootType && other.value == value) || value == other;
...
Node({required this.nodeId,this.parentId,required this.backendNodeId,required this.nodeType,required this.nodeName,required this.localName,required this.nodeValue,this.childNodeCount,this.children,this.attributes,this.documentURL,this.baseURL,this.publicId,this.systemId,this.internalSubset,this.xmlVersion,this.name,this.value,this.pseudoType,this.shadowRootType,this.frameId,this.contentDocument,this.shadowRoots,this.templateContent,this.pseudoElements,this.importedDocument,this.distributedNodes,this.isSVG});

factory Node.fromJson(Map<String, dynamic> json) {
return Node(
nodeId:  NodeId.fromJson(json['nodeId'] as int),
parentId:  json.containsKey('parentId') ? NodeId.fromJson(json['parentId'] as int) : null,
backendNodeId:  BackendNodeId.fromJson(json['backendNodeId'] as int),
nodeType:  json['nodeType'] as int,
nodeName:  json['nodeName'] as String,
localName:  json['localName'] as String,
nodeValue:  json['nodeValue'] as String,
childNodeCount:  json.containsKey('childNodeCount') ? json['childNodeCount'] as int : null,
children:  json.containsKey('children') ? (json['children'] as List).map((e) => Node.fromJson(e as Map<String, dynamic>)).toList() : null,
attributes:  json.containsKey('attributes') ? (json['attributes'] as List).map((e) => e as String).toList() : null,
documentURL:  json.containsKey('documentURL') ? json['documentURL'] as String : null,
baseURL:  json.containsKey('baseURL') ? json['baseURL'] as String : null,
publicId:  json.containsKey('publicId') ? json['publicId'] as String : null,
systemId:  json.containsKey('systemId') ? json['systemId'] as String : null,
internalSubset:  json.containsKey('internalSubset') ? json['internalSubset'] as String : null,
xmlVersion:  json.containsKey('xmlVersion') ? json['xmlVersion'] as String : null,
name:  json.containsKey('name') ? json['name'] as String : null,
value:  json.containsKey('value') ? json['value'] as String : null,
pseudoType:  json.containsKey('pseudoType') ? PseudoType.fromJson(json['pseudoType'] as String) : null,
shadowRootType:  json.containsKey('shadowRootType') ? ShadowRootType.fromJson(json['shadowRootType'] as String) : null,
frameId:  json.containsKey('frameId') ? page.FrameId.fromJson(json['frameId'] as String) : null,
contentDocument:  json.containsKey('contentDocument') ? Node.fromJson(json['contentDocument'] as Map<String, dynamic>) : null,
shadowRoots:  json.containsKey('shadowRoots') ? (json['shadowRoots'] as List).map((e) => Node.fromJson(e as Map<String, dynamic>)).toList() : null,
templateContent:  json.containsKey('templateContent') ? Node.fromJson(json['templateContent'] as Map<String, dynamic>) : null,
pseudoElements:  json.containsKey('pseudoElements') ? (json['pseudoElements'] as List).map((e) => Node.fromJson(e as Map<String, dynamic>)).toList() : null,
importedDocument:  json.containsKey('importedDocument') ? Node.fromJson(json['importedDocument'] as Map<String, dynamic>) : null,
distributedNodes:  json.containsKey('distributedNodes') ? (json['distributedNodes'] as List).map((e) => BackendNode.fromJson(e as Map<String, dynamic>)).toList() : null,
...
'shadowRootType' : shadowRootType.toJson(),
if (frameId != null) 
'frameId' : frameId.toJson(),
if (contentDocument != null) 
'contentDocument' : contentDocument.toJson(),
if (shadowRoots != null) 
'shadowRoots' : shadowRoots.map((e) => e.toJson()).toList(),
if (templateContent != null) 
'templateContent' : templateContent.toJson(),
...
@override
bool operator ==(other) => (other is Quad && other.value == value) || value == other;
...
BoxModel({required this.content,required this.padding,required this.border,required this.margin,required this.width,required this.height,this.shapeOutside});
...
shapeOutside:  json.containsKey('shapeOutside') ? ShapeOutsideInfo.fromJson(json['shapeOutside'] as Map<String, dynamic>) : null,
);
}
...
'shapeOutside' : shapeOutside.toJson(),
};}
}
...
marginShape:  (json['marginShape'] as List).map((e) => e as dynamic).toList(),
);
}
