...
var result =  await _client.send('DOMDebugger.getEventListeners', {'objectId' : objectId,if (depth != null)'depth' : depth,if (pierce != null)'pierce' : pierce,});
return (result['listeners'] as List).map((e) => EventListener.fromJson(e as Map<String, dynamic>)).toList();
}
...
Future<void> removeDOMBreakpoint(
  dom.NodeId nodeId,  DOMBreakpointType type
) async {
 await _client.send('DOMDebugger.removeDOMBreakpoint', {'nodeId' : nodeId,'type' : type,});
}
...
{  String? targetName}
 ...
 await _client.send('DOMDebugger.removeEventListenerBreakpoint', {'eventName' : eventName,if (targetName != null)'targetName' : targetName,});
}
...
Future<void> removeInstrumentationBreakpoint(
 ...
 await _client.send('DOMDebugger.removeInstrumentationBreakpoint', {'eventName' : eventName,});
}

  /// Removes breakpoint from XMLHttpRequest.
  /// [url] Resource URL substring.
Future<void> removeXHRBreakpoint(
  String url
) async {
...
Future<void> setDOMBreakpoint(
 ...
 await _client.send('DOMDebugger.setDOMBreakpoint', {'nodeId' : nodeId,'type' : type,});
}
...
{  String? targetName}
 ...
 await _client.send('DOMDebugger.setEventListenerBreakpoint', {'eventName' : eventName,if (targetName != null)'targetName' : targetName,});
}
...
Future<void> setInstrumentationBreakpoint(
 ...
 await _client.send('DOMDebugger.setInstrumentationBreakpoint', {'eventName' : eventName,});
}

  /// Sets breakpoint on XMLHttpRequest.
  /// [url] Resource URL substring. All XHRs having this substring in the URL will get stopped upon.
Future<void> setXHRBreakpoint(
  String url
) async {
...
@override
bool operator ==(other) => (other is DOMBreakpointType && other.value == value) || value == other;
...
EventListener({required this.type,required this.useCapture,required this.passive,required this.once,required this.scriptId,required this.lineNumber,required this.columnNumber,this.handler,this.originalHandler,this.backendNodeId});
...
handler:  json.containsKey('handler') ? runtime.RemoteObject.fromJson(json['handler'] as Map<String, dynamic>) : null,
originalHandler:  json.containsKey('originalHandler') ? runtime.RemoteObject.fromJson(json['originalHandler'] as Map<String, dynamic>) : null,
...
'originalHandler' : originalHandler.toJson(),
