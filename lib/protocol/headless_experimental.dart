...
Stream<bool> get onNeedsBeginFramesChanged => _client.onEvent.where((event) => event.name == 'HeadlessExperimental.needsBeginFramesChanged')
...
{  num? frameTimeTicks,  num? interval,  bool? noDisplayUpdates,  ScreenshotParams? screenshot}
) async {
var result =  await _client.send('HeadlessExperimental.beginFrame', {if (frameTimeTicks != null)'frameTimeTicks' : frameTimeTicks,if (interval != null)'interval' : interval,if (noDisplayUpdates != null)'noDisplayUpdates' : noDisplayUpdates,if (screenshot != null)'screenshot' : screenshot,});
...
screenshotData:  json.containsKey('screenshotData') ? json['screenshotData'] as String : null,
);
}
}
...
format:  json.containsKey('format') ? ScreenshotParamsFormat.fromJson(json['format'] as String) : null,
...
@override
bool operator ==(other) => (other is ScreenshotParamsFormat && other.value == value) || value == other;
