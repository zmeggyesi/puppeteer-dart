...
Future<void> clearObjectStore(
 ...
 await _client.send('IndexedDB.clearObjectStore', {'securityOrigin' : securityOrigin,'databaseName' : databaseName,'objectStoreName' : objectStoreName,});
}
...
Future<void> deleteDatabase(
 ...
 await _client.send('IndexedDB.deleteDatabase', {'securityOrigin' : securityOrigin,'databaseName' : databaseName,});
}

  /// Delete a range of entries from an object store
  /// [keyRange] Range of entry keys to delete
Future<void> deleteObjectStoreEntries(
  String securityOrigin,  String databaseName,  String objectStoreName,  KeyRange keyRange
) async {
 await _client.send('IndexedDB.deleteObjectStoreEntries', {'securityOrigin' : securityOrigin,'databaseName' : databaseName,'objectStoreName' : objectStoreName,'keyRange' : keyRange,});
}
...
Future<RequestDataResult> requestData(
  String securityOrigin,  String databaseName,  String objectStoreName,  String indexName,  int skipCount,  int pageSize
,
{  KeyRange? keyRange}
) async {
var result =  await _client.send('IndexedDB.requestData', {'securityOrigin' : securityOrigin,'databaseName' : databaseName,'objectStoreName' : objectStoreName,'indexName' : indexName,'skipCount' : skipCount,'pageSize' : pageSize,if (keyRange != null)'keyRange' : keyRange,});
...
var result =  await _client.send('IndexedDB.getMetadata', {'securityOrigin' : securityOrigin,'databaseName' : databaseName,'objectStoreName' : objectStoreName,});
...
var result =  await _client.send('IndexedDB.requestDatabase', {'securityOrigin' : securityOrigin,'databaseName' : databaseName,});
return DatabaseWithObjectStores.fromJson(result['databaseWithObjectStores'] as Map<String, dynamic>);
}
...
var result =  await _client.send('IndexedDB.requestDatabaseNames', {'securityOrigin' : securityOrigin,});
...
RequestDataResult({required this.objectStoreDataEntries,required this.hasMore});

factory RequestDataResult.fromJson(Map<String, dynamic> json) {
return RequestDataResult(
objectStoreDataEntries:  (json['objectStoreDataEntries'] as List).map((e) => DataEntry.fromJson(e as Map<String, dynamic>)).toList(),
...
GetMetadataResult({required this.entriesCount,required this.keyGeneratorValue});
...
DatabaseWithObjectStores({required this.name,required this.version,required this.objectStores});
...
objectStores:  (json['objectStores'] as List).map((e) => ObjectStore.fromJson(e as Map<String, dynamic>)).toList(),
);
}
...
ObjectStore({required this.name,required this.keyPath,required this.autoIncrement,required this.indexes});
...
indexes:  (json['indexes'] as List).map((e) => ObjectStoreIndex.fromJson(e as Map<String, dynamic>)).toList(),
);
}
...
ObjectStoreIndex({required this.name,required this.keyPath,required this.unique,required this.multiEntry});
...
array:  json.containsKey('array') ? (json['array'] as List).map((e) => Key.fromJson(e as Map<String, dynamic>)).toList() : null,
);
}
...
@override
bool operator ==(other) => (other is KeyType && other.value == value) || value == other;
...
KeyRange({this.lower,this.upper,required this.lowerOpen,required this.upperOpen});

factory KeyRange.fromJson(Map<String, dynamic> json) {
return KeyRange(
lower:  json.containsKey('lower') ? Key.fromJson(json['lower'] as Map<String, dynamic>) : null,
upper:  json.containsKey('upper') ? Key.fromJson(json['upper'] as Map<String, dynamic>) : null,
...
primaryKey:  runtime.RemoteObject.fromJson(json['primaryKey'] as Map<String, dynamic>),
value:  runtime.RemoteObject.fromJson(json['value'] as Map<String, dynamic>),
);
}
...
string:  json.containsKey('string') ? json['string'] as String : null,
array:  json.containsKey('array') ? (json['array'] as List).map((e) => e as String).toList() : null,
);
}
...
@override
bool operator ==(other) => (other is KeyPathType && other.value == value) || value == other;
