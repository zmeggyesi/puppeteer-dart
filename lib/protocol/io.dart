...
var result =  await _client.send('IO.read', {'handle' : handle,if (offset != null)'offset' : offset,if (size != null)'size' : size,});
...
return ReadResult(
base64Encoded:  json.containsKey('base64Encoded') ? json['base64Encoded'] as bool : null,
...
@override
bool operator ==(other) => (other is StreamHandle && other.value == value) || value == other;
