...
Stream<LayerPaintedEvent> get onLayerPainted => _client.onEvent.where((event) => event.name == 'LayerTree.layerPainted')
.map((event) => LayerPaintedEvent.fromJson(event.parameters))
;



Stream<List<Layer>> get onLayerTreeDidChange => _client.onEvent.where((event) => event.name == 'LayerTree.layerTreeDidChange')
.map((event) => (event.parameters['layers'] as List).map((e) => Layer.fromJson(e as Map<String, dynamic>)).toList())
;
...
var result =  await _client.send('LayerTree.compositingReasons', {'layerId' : layerId,});
return (result['compositingReasons'] as List).map((e) => e as String).toList();
}
...
var result =  await _client.send('LayerTree.loadSnapshot', {'tiles' : [...tiles],});
...
var result =  await _client.send('LayerTree.makeSnapshot', {'layerId' : layerId,});
return SnapshotId.fromJson(result['snapshotId'] as String);
}
...
,
{  int? minRepeatCount,  num? minDuration,  dom.Rect? clipRect}
) async {
var result =  await _client.send('LayerTree.profileSnapshot', {'snapshotId' : snapshotId,if (minRepeatCount != null)'minRepeatCount' : minRepeatCount,if (minDuration != null)'minDuration' : minDuration,if (clipRect != null)'clipRect' : clipRect,});
return (result['timings'] as List).map((e) => PaintProfile.fromJson(e as List<num>)).toList();
}

  /// Releases layer snapshot captured by the back-end.
  /// [snapshotId] The id of the layer snapshot.
Future<void> releaseSnapshot(
  SnapshotId snapshotId
) async {
 await _client.send('LayerTree.releaseSnapshot', {'snapshotId' : snapshotId,});
}
...
Future<String> replaySnapshot(
  SnapshotId snapshotId
,
{  int? fromStep,  int? toStep,  num? scale}
) async {
var result =  await _client.send('LayerTree.replaySnapshot', {'snapshotId' : snapshotId,if (fromStep != null)'fromStep' : fromStep,if (toStep != null)'toStep' : toStep,if (scale != null)'scale' : scale,});
...
var result =  await _client.send('LayerTree.snapshotCommandLog', {'snapshotId' : snapshotId,});
return (result['commandLog'] as List).map((e) => e as Map<String, dynamic>).toList();
}
...
@override
bool operator ==(other) => (other is LayerId && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is SnapshotId && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is ScrollRectType && other.value == value) || value == other;
...
StickyPositionConstraint({required this.stickyBoxRect,required this.containingBlockRect,this.nearestLayerShiftingStickyBox,this.nearestLayerShiftingContainingBlock});

factory StickyPositionConstraint.fromJson(Map<String, dynamic> json) {
return StickyPositionConstraint(
stickyBoxRect:  dom.Rect.fromJson(json['stickyBoxRect'] as Map<String, dynamic>),
containingBlockRect:  dom.Rect.fromJson(json['containingBlockRect'] as Map<String, dynamic>),
nearestLayerShiftingStickyBox:  json.containsKey('nearestLayerShiftingStickyBox') ? LayerId.fromJson(json['nearestLayerShiftingStickyBox'] as String) : null,
nearestLayerShiftingContainingBlock:  json.containsKey('nearestLayerShiftingContainingBlock') ? LayerId.fromJson(json['nearestLayerShiftingContainingBlock'] as String) : null,
);
}
...
'nearestLayerShiftingContainingBlock' : nearestLayerShiftingContainingBlock.toJson(),
};}
}
...
Layer({required this.layerId,this.parentLayerId,this.backendNodeId,required this.offsetX,required this.offsetY,required this.width,required this.height,this.transform,this.anchorX,this.anchorY,this.anchorZ,required this.paintCount,required this.drawsContent,this.invisible,this.scrollRects,this.stickyPositionConstraint});

factory Layer.fromJson(Map<String, dynamic> json) {
return Layer(
layerId:  LayerId.fromJson(json['layerId'] as String),
parentLayerId:  json.containsKey('parentLayerId') ? LayerId.fromJson(json['parentLayerId'] as String) : null,
backendNodeId:  json.containsKey('backendNodeId') ? dom.BackendNodeId.fromJson(json['backendNodeId'] as int) : null,
offsetX:  json['offsetX'] as num,
offsetY:  json['offsetY'] as num,
width:  json['width'] as num,
height:  json['height'] as num,
transform:  json.containsKey('transform') ? (json['transform'] as List).map((e) => e as num).toList() : null,
...
invisible:  json.containsKey('invisible') ? json['invisible'] as bool : null,
scrollRects:  json.containsKey('scrollRects') ? (json['scrollRects'] as List).map((e) => ScrollRect.fromJson(e as Map<String, dynamic>)).toList() : null,
stickyPositionConstraint:  json.containsKey('stickyPositionConstraint') ? StickyPositionConstraint.fromJson(json['stickyPositionConstraint'] as Map<String, dynamic>) : null,
);
}
...
'parentLayerId' : parentLayerId.toJson(),
...
factory PaintProfile.fromJson(List<dynamic> value) => PaintProfile(List<num>.from(value));

List<num> toJson() => value;

@override
bool operator ==(other) => (other is PaintProfile && other.value == value) || value == other;
