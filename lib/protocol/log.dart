...
Stream<LogEntry> get onEntryAdded => _client.onEvent.where((event) => event.name == 'Log.entryAdded')
.map((event) => LogEntry.fromJson(event.parameters['entry'] as Map<String, dynamic>))
;
...
Future<void> startViolationsReport(
  List<ViolationSetting> config
) async {
 await _client.send('Log.startViolationsReport', {'config' : [...config],});
}
...
LogEntry({required this.source,required this.level,required this.text,required this.timestamp,this.url,this.lineNumber,this.stackTrace,this.networkRequestId,this.workerId,this.args});
...
lineNumber:  json.containsKey('lineNumber') ? json['lineNumber'] as int : null,
stackTrace:  json.containsKey('stackTrace') ? runtime.StackTraceData.fromJson(json['stackTrace'] as Map<String, dynamic>) : null,
networkRequestId:  json.containsKey('networkRequestId') ? network.RequestId.fromJson(json['networkRequestId'] as String) : null,
workerId:  json.containsKey('workerId') ? json['workerId'] as String : null,
args:  json.containsKey('args') ? (json['args'] as List).map((e) => runtime.RemoteObject.fromJson(e as Map<String, dynamic>)).toList() : null,
);
}
...
@override
bool operator ==(other) => (other is LogEntrySource && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is LogEntryLevel && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is ViolationSettingName && other.value == value) || value == other;
