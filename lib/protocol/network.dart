...
Stream<DataReceivedEvent> get onDataReceived => _client.onEvent.where((event) => event.name == 'Network.dataReceived')
.map((event) => DataReceivedEvent.fromJson(event.parameters))
;


  /// Fired when EventSource message is received.
Stream<EventSourceMessageReceivedEvent> get onEventSourceMessageReceived => _client.onEvent.where((event) => event.name == 'Network.eventSourceMessageReceived')
.map((event) => EventSourceMessageReceivedEvent.fromJson(event.parameters))
;


  /// Fired when HTTP request has failed to load.
Stream<LoadingFailedEvent> get onLoadingFailed => _client.onEvent.where((event) => event.name == 'Network.loadingFailed')
.map((event) => LoadingFailedEvent.fromJson(event.parameters))
;


  /// Fired when HTTP request has finished loading.
Stream<LoadingFinishedEvent> get onLoadingFinished => _client.onEvent.where((event) => event.name == 'Network.loadingFinished')
...
Stream<RequestInterceptedEvent> get onRequestIntercepted => _client.onEvent.where((event) => event.name == 'Network.requestIntercepted')
.map((event) => RequestInterceptedEvent.fromJson(event.parameters))
;


  /// Fired if request ended up loading from cache.
Stream<RequestId> get onRequestServedFromCache => _client.onEvent.where((event) => event.name == 'Network.requestServedFromCache')
.map((event) => RequestId.fromJson(event.parameters['requestId'] as String))
;


  /// Fired when page is about to send HTTP request.
Stream<RequestWillBeSentEvent> get onRequestWillBeSent => _client.onEvent.where((event) => event.name == 'Network.requestWillBeSent')
.map((event) => RequestWillBeSentEvent.fromJson(event.parameters))
;


  /// Fired when resource loading priority is changed
Stream<ResourceChangedPriorityEvent> get onResourceChangedPriority => _client.onEvent.where((event) => event.name == 'Network.resourceChangedPriority')
.map((event) => ResourceChangedPriorityEvent.fromJson(event.parameters))
;


  /// Fired when a signed exchange was received over the network
Stream<SignedExchangeReceivedEvent> get onSignedExchangeReceived => _client.onEvent.where((event) => event.name == 'Network.signedExchangeReceived')
.map((event) => SignedExchangeReceivedEvent.fromJson(event.parameters))
;


  /// Fired when HTTP response is available.
Stream<ResponseReceivedEvent> get onResponseReceived => _client.onEvent.where((event) => event.name == 'Network.responseReceived')
.map((event) => ResponseReceivedEvent.fromJson(event.parameters))
;


  /// Fired when WebSocket is closed.
Stream<WebSocketClosedEvent> get onWebSocketClosed => _client.onEvent.where((event) => event.name == 'Network.webSocketClosed')
.map((event) => WebSocketClosedEvent.fromJson(event.parameters))
;


  /// Fired upon WebSocket creation.
Stream<WebSocketCreatedEvent> get onWebSocketCreated => _client.onEvent.where((event) => event.name == 'Network.webSocketCreated')
.map((event) => WebSocketCreatedEvent.fromJson(event.parameters))
;


  /// Fired when WebSocket message error occurs.
Stream<WebSocketFrameErrorEvent> get onWebSocketFrameError => _client.onEvent.where((event) => event.name == 'Network.webSocketFrameError')
.map((event) => WebSocketFrameErrorEvent.fromJson(event.parameters))
;


  /// Fired when WebSocket message is received.
Stream<WebSocketFrameReceivedEvent> get onWebSocketFrameReceived => _client.onEvent.where((event) => event.name == 'Network.webSocketFrameReceived')
.map((event) => WebSocketFrameReceivedEvent.fromJson(event.parameters))
;


  /// Fired when WebSocket message is sent.
Stream<WebSocketFrameSentEvent> get onWebSocketFrameSent => _client.onEvent.where((event) => event.name == 'Network.webSocketFrameSent')
.map((event) => WebSocketFrameSentEvent.fromJson(event.parameters))
;


  /// Fired when WebSocket handshake response becomes available.
Stream<WebSocketHandshakeResponseReceivedEvent> get onWebSocketHandshakeResponseReceived => _client.onEvent.where((event) => event.name == 'Network.webSocketHandshakeResponseReceived')
.map((event) => WebSocketHandshakeResponseReceivedEvent.fromJson(event.parameters))
;


  /// Fired when WebSocket is about to initiate handshake.
Stream<WebSocketWillSendHandshakeRequestEvent> get onWebSocketWillSendHandshakeRequest => _client.onEvent.where((event) => event.name == 'Network.webSocketWillSendHandshakeRequest')
.map((event) => WebSocketWillSendHandshakeRequestEvent.fromJson(event.parameters))
;
...
Stream<RequestWillBeSentExtraInfoEvent> get onRequestWillBeSentExtraInfo => _client.onEvent.where((event) => event.name == 'Network.requestWillBeSentExtraInfo')
.map((event) => RequestWillBeSentExtraInfoEvent.fromJson(event.parameters))
;
...
Stream<ResponseReceivedExtraInfoEvent> get onResponseReceivedExtraInfo => _client.onEvent.where((event) => event.name == 'Network.responseReceivedExtraInfo')
.map((event) => ResponseReceivedExtraInfoEvent.fromJson(event.parameters))
;
...
@deprecated
Future<bool> canClearBrowserCookies(
...
Future<void> clearBrowserCookies(
...
,
{  ErrorReason? errorReason,  String? rawResponse,  String? url,  String? method,  String? postData,  Headers? headers,  AuthChallengeResponse? authChallengeResponse}
) async {
 await _client.send('Network.continueInterceptedRequest', {'interceptionId' : interceptionId,if (errorReason != null)'errorReason' : errorReason,if (rawResponse != null)'rawResponse' : rawResponse,if (url != null)'url' : url,if (method != null)'method' : method,if (postData != null)'postData' : postData,if (headers != null)'headers' : headers,if (authChallengeResponse != null)'authChallengeResponse' : authChallengeResponse,});
}
...
{  String? url,  String? domain,  String? path}
 ...
 await _client.send('Network.deleteCookies', {'name' : name,if (url != null)'url' : url,if (domain != null)'domain' : domain,if (path != null)'path' : path,});
}
...
{  ConnectionType? connectionType}
 ...
 await _client.send('Network.emulateNetworkConditions', {'offline' : offline,'latency' : latency,'downloadThroughput' : downloadThroughput,'uploadThroughput' : uploadThroughput,if (connectionType != null)'connectionType' : connectionType,});
}
...
{  int? maxTotalBufferSize,  int? maxResourceBufferSize,  int? maxPostDataSize}
) async {
 await _client.send('Network.enable', {if (maxTotalBufferSize != null)'maxTotalBufferSize' : maxTotalBufferSize,if (maxResourceBufferSize != null)'maxResourceBufferSize' : maxResourceBufferSize,if (maxPostDataSize != null)'maxPostDataSize' : maxPostDataSize,});
}
...
return (result['cookies'] as List).map((e) => Cookie.fromJson(e as Map<String, dynamic>)).toList();
}
...
var result =  await _client.send('Network.getCertificate', {'origin' : origin,});
...
var result =  await _client.send('Network.getCookies', {if (urls != null)'urls' : [...urls],});
return (result['cookies'] as List).map((e) => Cookie.fromJson(e as Map<String, dynamic>)).toList();
}
...
var result =  await _client.send('Network.getResponseBody', {'requestId' : requestId,});
...
var result =  await _client.send('Network.getRequestPostData', {'requestId' : requestId,});
...
var result =  await _client.send('Network.getResponseBodyForInterception', {'interceptionId' : interceptionId,});
...
var result =  await _client.send('Network.takeResponseBodyForInterceptionAsStream', {'interceptionId' : interceptionId,});
...
var result =  await _client.send('Network.searchInResponseBody', {'requestId' : requestId,'query' : query,if (caseSensitive != null)'caseSensitive' : caseSensitive,if (isRegex != null)'isRegex' : isRegex,});
return (result['result'] as List).map((e) => debugger.SearchMatch.fromJson(e as Map<String, dynamic>)).toList();
}
...
Future<void> setBlockedURLs(
 ...
 await _client.send('Network.setBlockedURLs', {'urls' : [...urls],});
}

  /// Toggles ignoring of service worker for each request.
  /// [bypass] Bypass service worker and load from network.
Future<void> setBypassServiceWorker(
  bool bypass
) async {
...
Future<void> setCacheDisabled(
 ...
 await _client.send('Network.setCacheDisabled', {'cacheDisabled' : cacheDisabled,});
}
...
,
{  String? url,  String? domain,  String? path,  bool? secure,  bool? httpOnly,  CookieSameSite? sameSite,  TimeSinceEpoch? expires}
) async {
var result =  await _client.send('Network.setCookie', {'name' : name,'value' : value,if (url != null)'url' : url,if (domain != null)'domain' : domain,if (path != null)'path' : path,if (secure != null)'secure' : secure,if (httpOnly != null)'httpOnly' : httpOnly,if (sameSite != null)'sameSite' : sameSite,if (expires != null)'expires' : expires,});
...
Future<void> setCookies(
 ...
 await _client.send('Network.setCookies', {'cookies' : [...cookies],});
}
...
Future<void> setDataSizeLimitsForTest(
 ...
 await _client.send('Network.setDataSizeLimitsForTest', {'maxTotalSize' : maxTotalSize,'maxResourceSize' : maxResourceSize,});
}
...
Future<void> setRequestInterception(
 ...
 await _client.send('Network.setRequestInterception', {'patterns' : [...patterns],});
}
...
{  String? acceptLanguage,  String? platform}
 ...
 await _client.send('Network.setUserAgentOverride', {'userAgent' : userAgent,if (acceptLanguage != null)'acceptLanguage' : acceptLanguage,if (platform != null)'platform' : platform,});
}
...
DataReceivedEvent({required this.requestId,required this.timestamp,required this.dataLength,required this.encodedDataLength});
...
EventSourceMessageReceivedEvent({required this.requestId,required this.timestamp,required this.eventName,required this.eventId,required this.data});
...
LoadingFailedEvent({required this.requestId,required this.timestamp,required this.type,required this.errorText,this.canceled,this.blockedReason});
...
blockedReason:  json.containsKey('blockedReason') ? BlockedReason.fromJson(json['blockedReason'] as String) : null,
);
}
}
...
LoadingFinishedEvent({required this.requestId,required this.timestamp,required this.encodedDataLength,this.shouldReportCorbBlocking});
...
shouldReportCorbBlocking:  json.containsKey('shouldReportCorbBlocking') ? json['shouldReportCorbBlocking'] as bool : null,
);
}
}
...
RequestInterceptedEvent({required this.interceptionId,required this.request,required this.frameId,required this.resourceType,required this.isNavigationRequest,this.isDownload,this.redirectUrl,this.authChallenge,this.responseErrorReason,this.responseStatusCode,this.responseHeaders,this.requestId});
...
isDownload:  json.containsKey('isDownload') ? json['isDownload'] as bool : null,
redirectUrl:  json.containsKey('redirectUrl') ? json['redirectUrl'] as String : null,
authChallenge:  json.containsKey('authChallenge') ? AuthChallenge.fromJson(json['authChallenge'] as Map<String, dynamic>) : null,
responseErrorReason:  json.containsKey('responseErrorReason') ? ErrorReason.fromJson(json['responseErrorReason'] as String) : null,
responseStatusCode:  json.containsKey('responseStatusCode') ? json['responseStatusCode'] as int : null,
responseHeaders:  json.containsKey('responseHeaders') ? Headers.fromJson(json['responseHeaders'] as Map<String, dynamic>) : null,
requestId:  json.containsKey('requestId') ? RequestId.fromJson(json['requestId'] as String) : null,
);
}
}
...
RequestWillBeSentEvent({required this.requestId,required this.loaderId,required this.documentURL,required this.request,required this.timestamp,required this.wallTime,required this.initiator,this.redirectResponse,this.type,this.frameId,this.hasUserGesture});
...
redirectResponse:  json.containsKey('redirectResponse') ? ResponseData.fromJson(json['redirectResponse'] as Map<String, dynamic>) : null,
type:  json.containsKey('type') ? ResourceType.fromJson(json['type'] as String) : null,
frameId:  json.containsKey('frameId') ? page.FrameId.fromJson(json['frameId'] as String) : null,
hasUserGesture:  json.containsKey('hasUserGesture') ? json['hasUserGesture'] as bool : null,
);
}
}
...
ResourceChangedPriorityEvent({required this.requestId,required this.newPriority,required this.timestamp});
...
ResponseReceivedEvent({required this.requestId,required this.loaderId,required this.timestamp,required this.type,required this.response,this.frameId});
...
WebSocketCreatedEvent({required this.requestId,required this.url,this.initiator});

factory WebSocketCreatedEvent.fromJson(Map<String, dynamic> json) {
return WebSocketCreatedEvent(
requestId:  RequestId.fromJson(json['requestId'] as String),
url:  json['url'] as String,
initiator:  json.containsKey('initiator') ? Initiator.fromJson(json['initiator'] as Map<String, dynamic>) : null,
);
}
}
...
WebSocketFrameErrorEvent({required this.requestId,required this.timestamp,required this.errorMessage});
...
WebSocketFrameReceivedEvent({required this.requestId,required this.timestamp,required this.response});

factory WebSocketFrameReceivedEvent.fromJson(Map<String, dynamic> json) {
return WebSocketFrameReceivedEvent(
requestId:  RequestId.fromJson(json['requestId'] as String),
timestamp:  MonotonicTime.fromJson(json['timestamp'] as num),
response:  WebSocketFrame.fromJson(json['response'] as Map<String, dynamic>),
);
}
}
...
WebSocketFrameSentEvent({required this.requestId,required this.timestamp,required this.response});
...
WebSocketHandshakeResponseReceivedEvent({required this.requestId,required this.timestamp,required this.response});

factory WebSocketHandshakeResponseReceivedEvent.fromJson(Map<String, dynamic> json) {
return WebSocketHandshakeResponseReceivedEvent(
requestId:  RequestId.fromJson(json['requestId'] as String),
timestamp:  MonotonicTime.fromJson(json['timestamp'] as num),
response:  WebSocketResponse.fromJson(json['response'] as Map<String, dynamic>),
);
}
}
...
WebSocketWillSendHandshakeRequestEvent({required this.requestId,required this.timestamp,required this.wallTime,required this.request});

factory WebSocketWillSendHandshakeRequestEvent.fromJson(Map<String, dynamic> json) {
return WebSocketWillSendHandshakeRequestEvent(
requestId:  RequestId.fromJson(json['requestId'] as String),
timestamp:  MonotonicTime.fromJson(json['timestamp'] as num),
wallTime:  TimeSinceEpoch.fromJson(json['wallTime'] as num),
request:  WebSocketRequest.fromJson(json['request'] as Map<String, dynamic>),
);
}
}
...
RequestWillBeSentExtraInfoEvent({required this.requestId,required this.blockedCookies,required this.headers});

factory RequestWillBeSentExtraInfoEvent.fromJson(Map<String, dynamic> json) {
return RequestWillBeSentExtraInfoEvent(
requestId:  RequestId.fromJson(json['requestId'] as String),
blockedCookies:  (json['blockedCookies'] as List).map((e) => BlockedCookieWithReason.fromJson(e as Map<String, dynamic>)).toList(),
...
ResponseReceivedExtraInfoEvent({required this.requestId,required this.blockedCookies,required this.headers,this.headersText});

factory ResponseReceivedExtraInfoEvent.fromJson(Map<String, dynamic> json) {
return ResponseReceivedExtraInfoEvent(
requestId:  RequestId.fromJson(json['requestId'] as String),
blockedCookies:  (json['blockedCookies'] as List).map((e) => BlockedSetCookieWithReason.fromJson(e as Map<String, dynamic>)).toList(),
headers:  Headers.fromJson(json['headers'] as Map<String, dynamic>),
headersText:  json.containsKey('headersText') ? json['headersText'] as String : null,
);
}
}
...
GetResponseBodyForInterceptionResult({required this.body,required this.base64Encoded});

factory GetResponseBodyForInterceptionResult.fromJson(Map<String, dynamic> json) {
...
@override
bool operator ==(other) => (other is ResourceType && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is LoaderId && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is InterceptionId && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is ErrorReason && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is MonotonicTime && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is Headers && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is ConnectionType && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is CookieSameSite && other.value == value) || value == other;
...
ResourceTiming({required this.requestTime,required this.proxyStart,required this.proxyEnd,required this.dnsStart,required this.dnsEnd,required this.connectStart,required this.connectEnd,required this.sslStart,required this.sslEnd,required this.workerStart,required this.workerReady,required this.sendStart,required this.sendEnd,required this.pushStart,required this.pushEnd,required this.receiveHeadersEnd});
...
@override
bool operator ==(other) => (other is ResourcePriority && other.value == value) || value == other;
...
RequestData({required this.url,this.urlFragment,required this.method,required this.headers,this.postData,this.hasPostData,this.mixedContentType,required this.initialPriority,required this.referrerPolicy,this.isLinkPreload});

factory RequestData.fromJson(Map<String, dynamic> json) {
return RequestData(
url:  json['url'] as String,
urlFragment:  json.containsKey('urlFragment') ? json['urlFragment'] as String : null,
method:  json['method'] as String,
headers:  Headers.fromJson(json['headers'] as Map<String, dynamic>),
postData:  json.containsKey('postData') ? json['postData'] as String : null,
hasPostData:  json.containsKey('hasPostData') ? json['hasPostData'] as bool : null,
mixedContentType:  json.containsKey('mixedContentType') ? security.MixedContentType.fromJson(json['mixedContentType'] as String) : null,
initialPriority:  ResourcePriority.fromJson(json['initialPriority'] as String),
referrerPolicy:  RequestReferrerPolicy.fromJson(json['referrerPolicy'] as String),
isLinkPreload:  json.containsKey('isLinkPreload') ? json['isLinkPreload'] as bool : null,
);
}
...
static const noReferrerWhenDowngrade = RequestReferrerPolicy._('no-referrer-when-downgrade');
static const noReferrer = RequestReferrerPolicy._('no-referrer');
static const origin = RequestReferrerPolicy._('origin');
static const originWhenCrossOrigin = RequestReferrerPolicy._('origin-when-cross-origin');
...
static const strictOriginWhenCrossOrigin = RequestReferrerPolicy._('strict-origin-when-cross-origin');
static const values = {
...
@override
bool operator ==(other) => (other is RequestReferrerPolicy && other.value == value) || value == other;
...
SignedCertificateTimestamp({required this.status,required this.origin,required this.logDescription,required this.logId,required this.timestamp,required this.hashAlgorithm,required this.signatureAlgorithm,required this.signatureData});
...
SecurityDetails({required this.protocol,required this.keyExchange,this.keyExchangeGroup,required this.cipher,this.mac,required this.certificateId,required this.subjectName,required this.sanList,required this.issuer,required this.validFrom,required this.validTo,required this.signedCertificateTimestampList,required this.certificateTransparencyCompliance});

factory SecurityDetails.fromJson(Map<String, dynamic> json) {
return SecurityDetails(
protocol:  json['protocol'] as String,
keyExchange:  json['keyExchange'] as String,
keyExchangeGroup:  json.containsKey('keyExchangeGroup') ? json['keyExchangeGroup'] as String : null,
cipher:  json['cipher'] as String,
mac:  json.containsKey('mac') ? json['mac'] as String : null,
certificateId:  security.CertificateId.fromJson(json['certificateId'] as int),
...
signedCertificateTimestampList:  (json['signedCertificateTimestampList'] as List).map((e) => SignedCertificateTimestamp.fromJson(e as Map<String, dynamic>)).toList(),
certificateTransparencyCompliance:  CertificateTransparencyCompliance.fromJson(json['certificateTransparencyCompliance'] as String),
);
}
...
'signedCertificateTimestampList': signedCertificateTimestampList.map((e) => e.toJson()).toList(),
'certificateTransparencyCompliance': certificateTransparencyCompliance.toJson(),
...
static const notCompliant = CertificateTransparencyCompliance._('not-compliant');
...
factory CertificateTransparencyCompliance.fromJson(String value) => values[value];

String toJson() => value;

@override
bool operator ==(other) => (other is CertificateTransparencyCompliance && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is BlockedReason && other.value == value) || value == other;
...
ResponseData({required this.url,required this.status,required this.statusText,required this.headers,this.headersText,required this.mimeType,this.requestHeaders,this.requestHeadersText,required this.connectionReused,required this.connectionId,this.remoteIPAddress,this.remotePort,this.fromDiskCache,this.fromServiceWorker,this.fromPrefetchCache,required this.encodedDataLength,this.timing,this.protocol,required this.securityState,this.securityDetails});
...
requestHeaders:  json.containsKey('requestHeaders') ? Headers.fromJson(json['requestHeaders'] as Map<String, dynamic>) : null,
requestHeadersText:  json.containsKey('requestHeadersText') ? json['requestHeadersText'] as String : null,
connectionReused:  json['connectionReused'] as bool,
connectionId:  json['connectionId'] as num,
remoteIPAddress:  json.containsKey('remoteIPAddress') ? json['remoteIPAddress'] as String : null,
remotePort:  json.containsKey('remotePort') ? json['remotePort'] as int : null,
fromDiskCache:  json.containsKey('fromDiskCache') ? json['fromDiskCache'] as bool : null,
fromServiceWorker:  json.containsKey('fromServiceWorker') ? json['fromServiceWorker'] as bool : null,
fromPrefetchCache:  json.containsKey('fromPrefetchCache') ? json['fromPrefetchCache'] as bool : null,
encodedDataLength:  json['encodedDataLength'] as num,
timing:  json.containsKey('timing') ? ResourceTiming.fromJson(json['timing'] as Map<String, dynamic>) : null,
protocol:  json.containsKey('protocol') ? json['protocol'] as String : null,
securityState:  security.SecurityState.fromJson(json['securityState'] as String),
securityDetails:  json.containsKey('securityDetails') ? SecurityDetails.fromJson(json['securityDetails'] as Map<String, dynamic>) : null,
);
}
...
WebSocketResponse({required this.status,required this.statusText,required this.headers,this.headersText,this.requestHeaders,this.requestHeadersText});
...
WebSocketFrame({required this.opcode,required this.mask,required this.payloadData});
...
CachedResource({required this.url,required this.type,this.response,required this.bodySize});

factory CachedResource.fromJson(Map<String, dynamic> json) {
return CachedResource(
url:  json['url'] as String,
type:  ResourceType.fromJson(json['type'] as String),
response:  json.containsKey('response') ? ResponseData.fromJson(json['response'] as Map<String, dynamic>) : null,
...
stack:  json.containsKey('stack') ? runtime.StackTraceData.fromJson(json['stack'] as Map<String, dynamic>) : null,
url:  json.containsKey('url') ? json['url'] as String : null,
lineNumber:  json.containsKey('lineNumber') ? json['lineNumber'] as num : null,
);
}
...
@override
bool operator ==(other) => (other is InitiatorType && other.value == value) || value == other;
...
Cookie({required this.name,required this.value,required this.domain,required this.path,required this.expires,required this.size,required this.httpOnly,required this.secure,required this.session,this.sameSite});
...
sameSite:  json.containsKey('sameSite') ? CookieSameSite.fromJson(json['sameSite'] as String) : null,
);
}
...
static const sameSiteUnspecifiedTreatedAsLax = SetCookieBlockedReason._('SameSiteUnspecifiedTreatedAsLax');
static const sameSiteNoneInsecure = SetCookieBlockedReason._('SameSiteNoneInsecure');
...
static const schemeNotSupported = SetCookieBlockedReason._('SchemeNotSupported');
...
@override
bool operator ==(other) => (other is SetCookieBlockedReason && other.value == value) || value == other;
...
static const sameSiteUnspecifiedTreatedAsLax = CookieBlockedReason._('SameSiteUnspecifiedTreatedAsLax');
static const sameSiteNoneInsecure = CookieBlockedReason._('SameSiteNoneInsecure');
...
@override
bool operator ==(other) => (other is CookieBlockedReason && other.value == value) || value == other;
...
BlockedSetCookieWithReason({required this.blockedReason,required this.cookieLine,this.cookie});

factory BlockedSetCookieWithReason.fromJson(Map<String, dynamic> json) {
return BlockedSetCookieWithReason(
blockedReason:  SetCookieBlockedReason.fromJson(json['blockedReason'] as String),
cookieLine:  json['cookieLine'] as String,
cookie:  json.containsKey('cookie') ? Cookie.fromJson(json['cookie'] as Map<String, dynamic>) : null,
);
}
...
BlockedCookieWithReason({required this.blockedReason,required this.cookie});

factory BlockedCookieWithReason.fromJson(Map<String, dynamic> json) {
return BlockedCookieWithReason(
blockedReason:  CookieBlockedReason.fromJson(json['blockedReason'] as String),
...
CookieParam({required this.name,required this.value,this.url,this.domain,this.path,this.secure,this.httpOnly,this.sameSite,this.expires});
...
sameSite:  json.containsKey('sameSite') ? CookieSameSite.fromJson(json['sameSite'] as String) : null,
expires:  json.containsKey('expires') ? TimeSinceEpoch.fromJson(json['expires'] as num) : null,
);
}
...
@override
bool operator ==(other) => (other is InterceptionStage && other.value == value) || value == other;
...
resourceType:  json.containsKey('resourceType') ? ResourceType.fromJson(json['resourceType'] as String) : null,
interceptionStage:  json.containsKey('interceptionStage') ? InterceptionStage.fromJson(json['interceptionStage'] as String) : null,
);
}
...
SignedExchangeSignature({required this.label,required this.signature,required this.integrity,this.certUrl,this.certSha256,required this.validityUrl,required this.date,required this.expires,this.certificates});
...
certSha256:  json.containsKey('certSha256') ? json['certSha256'] as String : null,
validityUrl:  json['validityUrl'] as String,
date:  json['date'] as int,
expires:  json['expires'] as int,
certificates:  json.containsKey('certificates') ? (json['certificates'] as List).map((e) => e as String).toList() : null,
);
}
...
SignedExchangeHeader({required this.requestUrl,required this.responseCode,required this.responseHeaders,required this.signatures,required this.headerIntegrity});

factory SignedExchangeHeader.fromJson(Map<String, dynamic> json) {
return SignedExchangeHeader(
requestUrl:  json['requestUrl'] as String,
responseCode:  json['responseCode'] as int,
responseHeaders:  Headers.fromJson(json['responseHeaders'] as Map<String, dynamic>),
signatures:  (json['signatures'] as List).map((e) => SignedExchangeSignature.fromJson(e as Map<String, dynamic>)).toList(),
...
static const signatureIntegrity = SignedExchangeErrorField._('signatureIntegrity');
static const signatureCertUrl = SignedExchangeErrorField._('signatureCertUrl');
static const signatureCertSha256 = SignedExchangeErrorField._('signatureCertSha256');
static const signatureValidityUrl = SignedExchangeErrorField._('signatureValidityUrl');
static const signatureTimestamps = SignedExchangeErrorField._('signatureTimestamps');
static const values = {
...
@override
bool operator ==(other) => (other is SignedExchangeErrorField && other.value == value) || value == other;
...
SignedExchangeError({required this.message,this.signatureIndex,this.errorField});

factory SignedExchangeError.fromJson(Map<String, dynamic> json) {
return SignedExchangeError(
message:  json['message'] as String,
signatureIndex:  json.containsKey('signatureIndex') ? json['signatureIndex'] as int : null,
errorField:  json.containsKey('errorField') ? SignedExchangeErrorField.fromJson(json['errorField'] as String) : null,
);
}
...
SignedExchangeInfo({required this.outerResponse,this.header,this.securityDetails,this.errors});

factory SignedExchangeInfo.fromJson(Map<String, dynamic> json) {
return SignedExchangeInfo(
outerResponse:  ResponseData.fromJson(json['outerResponse'] as Map<String, dynamic>),
header:  json.containsKey('header') ? SignedExchangeHeader.fromJson(json['header'] as Map<String, dynamic>) : null,
securityDetails:  json.containsKey('securityDetails') ? SecurityDetails.fromJson(json['securityDetails'] as Map<String, dynamic>) : null,
errors:  json.containsKey('errors') ? (json['errors'] as List).map((e) => SignedExchangeError.fromJson(e as Map<String, dynamic>)).toList() : null,
);
}
