...
Stream<MetricsEvent> get onMetrics => _client.onEvent.where((event) => event.name == 'Performance.metrics')
...
return (result['metrics'] as List).map((e) => Metric.fromJson(e as Map<String, dynamic>)).toList();
}
