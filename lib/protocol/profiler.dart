...
Stream<ConsoleProfileFinishedEvent> get onConsoleProfileFinished => _client.onEvent.where((event) => event.name == 'Profiler.consoleProfileFinished')
.map((event) => ConsoleProfileFinishedEvent.fromJson(event.parameters))
;


  /// Sent when new profile recording is started using console.profile() call.
Stream<ConsoleProfileStartedEvent> get onConsoleProfileStarted => _client.onEvent.where((event) => event.name == 'Profiler.consoleProfileStarted')
...
Future<List<ScriptCoverage>> getBestEffortCoverage(

) async {
var result =  await _client.send('Profiler.getBestEffortCoverage');
return (result['result'] as List).map((e) => ScriptCoverage.fromJson(e as Map<String, dynamic>)).toList();
}
...
Future<void> startPreciseCoverage(

{  bool? callCount,  bool? detailed}
) async {
 await _client.send('Profiler.startPreciseCoverage', {if (callCount != null)'callCount' : callCount,if (detailed != null)'detailed' : detailed,});
}

  /// Enable type profile.
Future<void> startTypeProfile(
...
Future<void> stopTypeProfile(
 ...
 await _client.send('Profiler.stopTypeProfile');
  ...
  /// Returns: Coverage data for the current isolate.
Future<List<ScriptCoverage>> takePreciseCoverage(
...
Future<List<ScriptTypeProfile>> takeTypeProfile(

) async {
var result =  await _client.send('Profiler.takeTypeProfile');
return (result['result'] as List).map((e) => ScriptTypeProfile.fromJson(e as Map<String, dynamic>)).toList();
}
...
ConsoleProfileFinishedEvent({required this.id,required this.location,required this.profile,this.title});

factory ConsoleProfileFinishedEvent.fromJson(Map<String, dynamic> json) {
return ConsoleProfileFinishedEvent(
id:  json['id'] as String,
location:  debugger.Location.fromJson(json['location'] as Map<String, dynamic>),
...
ProfileNode({required this.id,required this.callFrame,this.hitCount,this.children,this.deoptReason,this.positionTicks});

factory ProfileNode.fromJson(Map<String, dynamic> json) {
return ProfileNode(
id:  json['id'] as int,
callFrame:  runtime.CallFrame.fromJson(json['callFrame'] as Map<String, dynamic>),
hitCount:  json.containsKey('hitCount') ? json['hitCount'] as int : null,
children:  json.containsKey('children') ? (json['children'] as List).map((e) => e as int).toList() : null,
deoptReason:  json.containsKey('deoptReason') ? json['deoptReason'] as String : null,
positionTicks:  json.containsKey('positionTicks') ? (json['positionTicks'] as List).map((e) => PositionTickInfo.fromJson(e as Map<String, dynamic>)).toList() : null,
);
}
...
Profile({required this.nodes,required this.startTime,required this.endTime,this.samples,this.timeDeltas});

factory Profile.fromJson(Map<String, dynamic> json) {
return Profile(
nodes:  (json['nodes'] as List).map((e) => ProfileNode.fromJson(e as Map<String, dynamic>)).toList(),
startTime:  json['startTime'] as num,
endTime:  json['endTime'] as num,
samples:  json.containsKey('samples') ? (json['samples'] as List).map((e) => e as int).toList() : null,
timeDeltas:  json.containsKey('timeDeltas') ? (json['timeDeltas'] as List).map((e) => e as int).toList() : null,
);
}
...
CoverageRange({required this.startOffset,required this.endOffset,required this.count});
...
FunctionCoverage({required this.functionName,required this.ranges,required this.isBlockCoverage});

factory FunctionCoverage.fromJson(Map<String, dynamic> json) {
return FunctionCoverage(
functionName:  json['functionName'] as String,
ranges:  (json['ranges'] as List).map((e) => CoverageRange.fromJson(e as Map<String, dynamic>)).toList(),
...
ScriptCoverage({required this.scriptId,required this.url,required this.functions});
...
functions:  (json['functions'] as List).map((e) => FunctionCoverage.fromJson(e as Map<String, dynamic>)).toList(),
);
}
...
types:  (json['types'] as List).map((e) => TypeObject.fromJson(e as Map<String, dynamic>)).toList(),
);
}
...
ScriptTypeProfile({required this.scriptId,required this.url,required this.entries});

factory ScriptTypeProfile.fromJson(Map<String, dynamic> json) {
return ScriptTypeProfile(
scriptId:  runtime.ScriptId.fromJson(json['scriptId'] as String),
url:  json['url'] as String,
entries:  (json['entries'] as List).map((e) => TypeProfileEntry.fromJson(e as Map<String, dynamic>)).toList(),
);
}
