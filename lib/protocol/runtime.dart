...
Stream<BindingCalledEvent> get onBindingCalled => _client.onEvent.where((event) => event.name == 'Runtime.bindingCalled')
.map((event) => BindingCalledEvent.fromJson(event.parameters))
;


  /// Issued when console API was called.
Stream<ConsoleAPICalledEvent> get onConsoleAPICalled => _client.onEvent.where((event) => event.name == 'Runtime.consoleAPICalled')
.map((event) => ConsoleAPICalledEvent.fromJson(event.parameters))
;


  /// Issued when unhandled exception was revoked.
Stream<ExceptionRevokedEvent> get onExceptionRevoked => _client.onEvent.where((event) => event.name == 'Runtime.exceptionRevoked')
.map((event) => ExceptionRevokedEvent.fromJson(event.parameters))
;


  /// Issued when exception was thrown and unhandled.
Stream<ExceptionThrownEvent> get onExceptionThrown => _client.onEvent.where((event) => event.name == 'Runtime.exceptionThrown')
.map((event) => ExceptionThrownEvent.fromJson(event.parameters))
;


  /// Issued when new execution context is created.
Stream<ExecutionContextDescription> get onExecutionContextCreated => _client.onEvent.where((event) => event.name == 'Runtime.executionContextCreated')
.map((event) => ExecutionContextDescription.fromJson(event.parameters['context'] as Map<String, dynamic>))
;


  /// Issued when execution context is destroyed.
Stream<ExecutionContextId> get onExecutionContextDestroyed => _client.onEvent.where((event) => event.name == 'Runtime.executionContextDestroyed')
.map((event) => ExecutionContextId.fromJson(event.parameters['executionContextId'] as int))
;


  /// Issued when all executionContexts were cleared in browser
Stream get onExecutionContextsCleared => _client.onEvent.where((event) => event.name == 'Runtime.executionContextsCleared')
;


  /// Issued when object should be inspected (for example, as a result of inspect() command line API
  /// call).
Stream<InspectRequestedEvent> get onInspectRequested => _client.onEvent.where((event) => event.name == 'Runtime.inspectRequested')
...
var result =  await _client.send('Runtime.awaitPromise', {'promiseObjectId' : promiseObjectId,if (returnByValue != null)'returnByValue' : returnByValue,if (generatePreview != null)'generatePreview' : generatePreview,});
...
,
{  RemoteObjectId? objectId,  List<CallArgument>? arguments,  bool? silent,  bool? returnByValue,  bool? generatePreview,  bool? userGesture,  bool? awaitPromise,  ExecutionContextId? executionContextId,  String? objectGroup}
) async {
var result =  await _client.send('Runtime.callFunctionOn', {'functionDeclaration' : functionDeclaration,if (objectId != null)'objectId' : objectId,if (arguments != null)'arguments' : [...arguments],if (silent != null)'silent' : silent,if (returnByValue != null)'returnByValue' : returnByValue,if (generatePreview != null)'generatePreview' : generatePreview,if (userGesture != null)'userGesture' : userGesture,if (awaitPromise != null)'awaitPromise' : awaitPromise,if (executionContextId != null)'executionContextId' : executionContextId,if (objectGroup != null)'objectGroup' : objectGroup,});
...
var result =  await _client.send('Runtime.compileScript', {'expression' : expression,'sourceURL' : sourceURL,'persistScript' : persistScript,if (executionContextId != null)'executionContextId' : executionContextId,});
...
Future<void> discardConsoleEntries(
...
Future<EvaluateResult> evaluate(
  String expression
,
{  String? objectGroup,  bool? includeCommandLineAPI,  bool? silent,  ExecutionContextId? contextId,  bool? returnByValue,  bool? generatePreview,  bool? userGesture,  bool? awaitPromise,  bool? throwOnSideEffect,  TimeDelta? timeout}
) async {
var result =  await _client.send('Runtime.evaluate', {'expression' : expression,if (objectGroup != null)'objectGroup' : objectGroup,if (includeCommandLineAPI != null)'includeCommandLineAPI' : includeCommandLineAPI,if (silent != null)'silent' : silent,if (contextId != null)'contextId' : contextId,if (returnByValue != null)'returnByValue' : returnByValue,if (generatePreview != null)'generatePreview' : generatePreview,if (userGesture != null)'userGesture' : userGesture,if (awaitPromise != null)'awaitPromise' : awaitPromise,if (throwOnSideEffect != null)'throwOnSideEffect' : throwOnSideEffect,if (timeout != null)'timeout' : timeout,});
return EvaluateResult.fromJson(result);
}

  /// Returns the isolate id.
  /// Returns: The isolate id.
Future<String> getIsolateId(
...
Future<GetHeapUsageResult> getHeapUsage(
...
var result =  await _client.send('Runtime.getProperties', {'objectId' : objectId,if (ownProperties != null)'ownProperties' : ownProperties,if (accessorPropertiesOnly != null)'accessorPropertiesOnly' : accessorPropertiesOnly,if (generatePreview != null)'generatePreview' : generatePreview,});
...
var result =  await _client.send('Runtime.globalLexicalScopeNames', {if (executionContextId != null)'executionContextId' : executionContextId,});
...
var result =  await _client.send('Runtime.queryObjects', {'prototypeObjectId' : prototypeObjectId,if (objectGroup != null)'objectGroup' : objectGroup,});
...
Future<void> releaseObjectGroup(
  String objectGroup
) async {
 await _client.send('Runtime.releaseObjectGroup', {'objectGroup' : objectGroup,});
}
...
Future<RunScriptResult> runScript(
  ScriptId scriptId
,
{  ExecutionContextId? executionContextId,  String? objectGroup,  bool? silent,  bool? includeCommandLineAPI,  bool? returnByValue,  bool? generatePreview,  bool? awaitPromise}
) async {
var result =  await _client.send('Runtime.runScript', {'scriptId' : scriptId,if (executionContextId != null)'executionContextId' : executionContextId,if (objectGroup != null)'objectGroup' : objectGroup,if (silent != null)'silent' : silent,if (includeCommandLineAPI != null)'includeCommandLineAPI' : includeCommandLineAPI,if (returnByValue != null)'returnByValue' : returnByValue,if (generatePreview != null)'generatePreview' : generatePreview,if (awaitPromise != null)'awaitPromise' : awaitPromise,});
...
Future<void> setAsyncCallStackDepth(
 ...
 await _client.send('Runtime.setAsyncCallStackDepth', {'maxDepth' : maxDepth,});
}


Future<void> setCustomObjectFormatterEnabled(
  bool enabled
) async {
 await _client.send('Runtime.setCustomObjectFormatterEnabled', {'enabled' : enabled,});
}


Future<void> setMaxCallStackSizeToCapture(
  int size
) async {
...
Future<void> terminateExecution(
...
{  ExecutionContextId? executionContextId}
 ...
 await _client.send('Runtime.addBinding', {'name' : name,if (executionContextId != null)'executionContextId' : executionContextId,});
}
...
ConsoleAPICalledEvent({required this.type,required this.args,required this.executionContextId,required this.timestamp,this.stackTrace,this.context});
...
stackTrace:  json.containsKey('stackTrace') ? StackTraceData.fromJson(json['stackTrace'] as Map<String, dynamic>) : null,
...
exceptionDetails:  json.containsKey('exceptionDetails') ? ExceptionDetails.fromJson(json['exceptionDetails'] as Map<String, dynamic>) : null,
);
}
}
...
internalProperties:  json.containsKey('internalProperties') ? (json['internalProperties'] as List).map((e) => InternalPropertyDescriptor.fromJson(e as Map<String, dynamic>)).toList() : null,
privateProperties:  json.containsKey('privateProperties') ? (json['privateProperties'] as List).map((e) => PrivatePropertyDescriptor.fromJson(e as Map<String, dynamic>)).toList() : null,
exceptionDetails:  json.containsKey('exceptionDetails') ? ExceptionDetails.fromJson(json['exceptionDetails'] as Map<String, dynamic>) : null,
);
}
}
...
RemoteObject({required this.type,this.subtype,this.className,this.value,this.unserializableValue,this.description,this.objectId,this.preview,this.customPreview});
...
unserializableValue:  json.containsKey('unserializableValue') ? UnserializableValue.fromJson(json['unserializableValue'] as String) : null,
...
customPreview:  json.containsKey('customPreview') ? CustomPreview.fromJson(json['customPreview'] as Map<String, dynamic>) : null,
);
}
...
'customPreview' : customPreview.toJson(),
};}
}
...
@override
bool operator ==(other) => (other is RemoteObjectType && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is RemoteObjectSubtype && other.value == value) || value == other;
...
'bodyGetterId' : bodyGetterId.toJson(),
};}
}
...
ObjectPreview({required this.type,this.subtype,this.description,required this.overflow,required this.properties,this.entries});
...
entries:  json.containsKey('entries') ? (json['entries'] as List).map((e) => EntryPreview.fromJson(e as Map<String, dynamic>)).toList() : null,
);
}
...
@override
bool operator ==(other) => (other is ObjectPreviewType && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is ObjectPreviewSubtype && other.value == value) || value == other;
...
valuePreview:  json.containsKey('valuePreview') ? ObjectPreview.fromJson(json['valuePreview'] as Map<String, dynamic>) : null,
...
'valuePreview' : valuePreview.toJson(),
if (subtype != null) 
'subtype' : subtype,
};}
}
...
@override
bool operator ==(other) => (other is PropertyPreviewType && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is PropertyPreviewSubtype && other.value == value) || value == other;
...
PropertyDescriptor({required this.name,this.value,this.writable,this.get,this.set,required this.configurable,required this.enumerable,this.wasThrown,this.isOwn,this.symbol});
...
ExecutionContextDescription({required this.id,required this.origin,required this.name,this.auxData});
...
ExceptionDetails({required this.exceptionId,required this.text,required this.lineNumber,required this.columnNumber,this.scriptId,this.url,this.stackTrace,this.exception,this.executionContextId});
...
stackTrace:  json.containsKey('stackTrace') ? StackTraceData.fromJson(json['stackTrace'] as Map<String, dynamic>) : null,
exception:  json.containsKey('exception') ? RemoteObject.fromJson(json['exception'] as Map<String, dynamic>) : null,
executionContextId:  json.containsKey('executionContextId') ? ExecutionContextId.fromJson(json['executionContextId'] as int) : null,
);
}
...
CallFrame({required this.functionName,required this.scriptId,required this.url,required this.lineNumber,required this.columnNumber});
...
static const startGroupCollapsed = ConsoleAPICalledEventType._('startGroupCollapsed');
...
@override
bool operator ==(other) => (other is ConsoleAPICalledEventType && other.value == value) || value == other;
