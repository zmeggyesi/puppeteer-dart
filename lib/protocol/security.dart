...
Stream<CertificateErrorEvent> get onCertificateError => _client.onEvent.where((event) => event.name == 'Security.certificateError')
.map((event) => CertificateErrorEvent.fromJson(event.parameters))
;


  /// The security state of the page changed.
Stream<SecurityStateChangedEvent> get onSecurityStateChanged => _client.onEvent.where((event) => event.name == 'Security.securityStateChanged')
...
Future<void> setIgnoreCertificateErrors(
  bool ignore
) async {
 await _client.send('Security.setIgnoreCertificateErrors', {'ignore' : ignore,});
}
...
Future<void> handleCertificateError(
  int eventId,  CertificateErrorAction action
) async {
 await _client.send('Security.handleCertificateError', {'eventId' : eventId,'action' : action,});
}
...
@deprecated
Future<void> setOverrideCertificateErrors(
  bool override
) async {
 await _client.send('Security.setOverrideCertificateErrors', {'override' : override,});
}
...
CertificateErrorEvent({required this.eventId,required this.errorType,required this.requestURL});
...
SecurityStateChangedEvent({required this.securityState,required this.explanations,this.summary});
...
explanations:  (json['explanations'] as List).map((e) => SecurityStateExplanation.fromJson(e as Map<String, dynamic>)).toList(),
...
@override
bool operator ==(other) => (other is CertificateId && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is MixedContentType && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is SecurityState && other.value == value) || value == other;
...
SecurityStateExplanation({required this.securityState,required this.title,required this.summary,required this.description,required this.mixedContentType,required this.certificate,this.recommendations});
...
mixedContentType:  MixedContentType.fromJson(json['mixedContentType'] as String),
certificate:  (json['certificate'] as List).map((e) => e as String).toList(),
recommendations:  json.containsKey('recommendations') ? (json['recommendations'] as List).map((e) => e as String).toList() : null,
);
}
...
InsecureContentStatus({required this.ranMixedContent,required this.displayedMixedContent,required this.containedMixedForm,required this.ranContentWithCertErrors,required this.displayedContentWithCertErrors,required this.ranInsecureContentStyle,required this.displayedInsecureContentStyle});
...
displayedContentWithCertErrors:  json['displayedContentWithCertErrors'] as bool,
ranInsecureContentStyle:  SecurityState.fromJson(json['ranInsecureContentStyle'] as String),
displayedInsecureContentStyle:  SecurityState.fromJson(json['displayedInsecureContentStyle'] as String),
);
}
...
@override
bool operator ==(other) => (other is CertificateErrorAction && other.value == value) || value == other;
