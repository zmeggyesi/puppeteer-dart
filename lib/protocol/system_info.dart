...
return (result['processInfo'] as List).map((e) => ProcessInfo.fromJson(e as Map<String, dynamic>)).toList();
}
...
GetInfoResult({required this.gpu,required this.modelName,required this.modelVersion,required this.commandLine});
...
GPUDevice({required this.vendorId,required this.deviceId,required this.vendorString,required this.deviceString,required this.driverVendor,required this.driverVersion});
...
VideoDecodeAcceleratorCapability({required this.profile,required this.maxResolution,required this.minResolution});

factory VideoDecodeAcceleratorCapability.fromJson(Map<String, dynamic> json) {
return VideoDecodeAcceleratorCapability(
profile:  json['profile'] as String,
maxResolution:  Size.fromJson(json['maxResolution'] as Map<String, dynamic>),
minResolution:  Size.fromJson(json['minResolution'] as Map<String, dynamic>),
);
}
...
VideoEncodeAcceleratorCapability({required this.profile,required this.maxResolution,required this.maxFramerateNumerator,required this.maxFramerateDenominator});
...
@override
bool operator ==(other) => (other is SubsamplingFormat && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is ImageType && other.value == value) || value == other;
...
ImageDecodeAcceleratorCapability({required this.imageType,required this.maxDimensions,required this.minDimensions,required this.subsamplings});
...
maxDimensions:  Size.fromJson(json['maxDimensions'] as Map<String, dynamic>),
minDimensions:  Size.fromJson(json['minDimensions'] as Map<String, dynamic>),
subsamplings:  (json['subsamplings'] as List).map((e) => SubsamplingFormat.fromJson(e as String)).toList(),
);
}
...
GPUInfo({required this.devices,this.auxAttributes,this.featureStatus,required this.driverBugWorkarounds,required this.videoDecoding,required this.videoEncoding,required this.imageDecoding});

factory GPUInfo.fromJson(Map<String, dynamic> json) {
return GPUInfo(
devices:  (json['devices'] as List).map((e) => GPUDevice.fromJson(e as Map<String, dynamic>)).toList(),
auxAttributes:  json.containsKey('auxAttributes') ? json['auxAttributes'] as Map<String, dynamic> : null,
featureStatus:  json.containsKey('featureStatus') ? json['featureStatus'] as Map<String, dynamic> : null,
driverBugWorkarounds:  (json['driverBugWorkarounds'] as List).map((e) => e as String).toList(),
videoDecoding:  (json['videoDecoding'] as List).map((e) => VideoDecodeAcceleratorCapability.fromJson(e as Map<String, dynamic>)).toList(),
videoEncoding:  (json['videoEncoding'] as List).map((e) => VideoEncodeAcceleratorCapability.fromJson(e as Map<String, dynamic>)).toList(),
imageDecoding:  (json['imageDecoding'] as List).map((e) => ImageDecodeAcceleratorCapability.fromJson(e as Map<String, dynamic>)).toList(),
);
}
