...
Stream<BaseAudioContext> get onContextCreated => _client.onEvent.where((event) => event.name == 'WebAudio.contextCreated')
.map((event) => BaseAudioContext.fromJson(event.parameters['context'] as Map<String, dynamic>))
;


  /// Notifies that an existing BaseAudioContext will be destroyed.
Stream<GraphObjectId> get onContextWillBeDestroyed => _client.onEvent.where((event) => event.name == 'WebAudio.contextWillBeDestroyed')
.map((event) => GraphObjectId.fromJson(event.parameters['contextId'] as String))
;


  /// Notifies that existing BaseAudioContext has changed some properties (id stays the same)..
Stream<BaseAudioContext> get onContextChanged => _client.onEvent.where((event) => event.name == 'WebAudio.contextChanged')
.map((event) => BaseAudioContext.fromJson(event.parameters['context'] as Map<String, dynamic>))
;


  /// Notifies that the construction of an AudioListener has finished.
Stream<AudioListener> get onAudioListenerCreated => _client.onEvent.where((event) => event.name == 'WebAudio.audioListenerCreated')
.map((event) => AudioListener.fromJson(event.parameters['listener'] as Map<String, dynamic>))
;


  /// Notifies that a new AudioListener has been created.
Stream<AudioListenerWillBeDestroyedEvent> get onAudioListenerWillBeDestroyed => _client.onEvent.where((event) => event.name == 'WebAudio.audioListenerWillBeDestroyed')
.map((event) => AudioListenerWillBeDestroyedEvent.fromJson(event.parameters))
;


  /// Notifies that a new AudioNode has been created.
Stream<AudioNode> get onAudioNodeCreated => _client.onEvent.where((event) => event.name == 'WebAudio.audioNodeCreated')
.map((event) => AudioNode.fromJson(event.parameters['node'] as Map<String, dynamic>))
;


  /// Notifies that an existing AudioNode has been destroyed.
Stream<AudioNodeWillBeDestroyedEvent> get onAudioNodeWillBeDestroyed => _client.onEvent.where((event) => event.name == 'WebAudio.audioNodeWillBeDestroyed')
.map((event) => AudioNodeWillBeDestroyedEvent.fromJson(event.parameters))
;


  /// Notifies that a new AudioParam has been created.
Stream<AudioParam> get onAudioParamCreated => _client.onEvent.where((event) => event.name == 'WebAudio.audioParamCreated')
.map((event) => AudioParam.fromJson(event.parameters['param'] as Map<String, dynamic>))
;


  /// Notifies that an existing AudioParam has been destroyed.
Stream<AudioParamWillBeDestroyedEvent> get onAudioParamWillBeDestroyed => _client.onEvent.where((event) => event.name == 'WebAudio.audioParamWillBeDestroyed')
.map((event) => AudioParamWillBeDestroyedEvent.fromJson(event.parameters))
;


  /// Notifies that two AudioNodes are connected.
Stream<NodesConnectedEvent> get onNodesConnected => _client.onEvent.where((event) => event.name == 'WebAudio.nodesConnected')
.map((event) => NodesConnectedEvent.fromJson(event.parameters))
;


  /// Notifies that AudioNodes are disconnected. The destination can be null, and it means all the outgoing connections from the source are disconnected.
Stream<NodesDisconnectedEvent> get onNodesDisconnected => _client.onEvent.where((event) => event.name == 'WebAudio.nodesDisconnected')
.map((event) => NodesDisconnectedEvent.fromJson(event.parameters))
;


  /// Notifies that an AudioNode is connected to an AudioParam.
Stream<NodeParamConnectedEvent> get onNodeParamConnected => _client.onEvent.where((event) => event.name == 'WebAudio.nodeParamConnected')
.map((event) => NodeParamConnectedEvent.fromJson(event.parameters))
;


  /// Notifies that an AudioNode is disconnected to an AudioParam.
Stream<NodeParamDisconnectedEvent> get onNodeParamDisconnected => _client.onEvent.where((event) => event.name == 'WebAudio.nodeParamDisconnected')
...
var result =  await _client.send('WebAudio.getRealtimeData', {'contextId' : contextId,});
return ContextRealtimeData.fromJson(result['realtimeData'] as Map<String, dynamic>);
}
...
AudioListenerWillBeDestroyedEvent({required this.contextId,required this.listenerId});

factory AudioListenerWillBeDestroyedEvent.fromJson(Map<String, dynamic> json) {
...
AudioNodeWillBeDestroyedEvent({required this.contextId,required this.nodeId});
...
AudioParamWillBeDestroyedEvent({required this.contextId,required this.nodeId,required this.paramId});
...
NodesConnectedEvent({required this.contextId,required this.sourceId,required this.destinationId,this.sourceOutputIndex,this.destinationInputIndex});
...
sourceOutputIndex:  json.containsKey('sourceOutputIndex') ? json['sourceOutputIndex'] as num : null,
destinationInputIndex:  json.containsKey('destinationInputIndex') ? json['destinationInputIndex'] as num : null,
);
}
}
...
NodesDisconnectedEvent({required this.contextId,required this.sourceId,required this.destinationId,this.sourceOutputIndex,this.destinationInputIndex});
...
NodeParamConnectedEvent({required this.contextId,required this.sourceId,required this.destinationId,this.sourceOutputIndex});
...
NodeParamDisconnectedEvent({required this.contextId,required this.sourceId,required this.destinationId,this.sourceOutputIndex});
...
@override
bool operator ==(other) => (other is GraphObjectId && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is ContextType && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is ContextState && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is NodeType && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is ChannelCountMode && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is ChannelInterpretation && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is ParamType && other.value == value) || value == other;
...
@override
bool operator ==(other) => (other is AutomationRate && other.value == value) || value == other;
...
ContextRealtimeData({required this.currentTime,required this.renderCapacity,required this.callbackIntervalMean,required this.callbackIntervalVariance});
...
BaseAudioContext({required this.contextId,required this.contextType,required this.contextState,this.realtimeData,required this.callbackBufferSize,required this.maxOutputChannelCount,required this.sampleRate});
...
realtimeData:  json.containsKey('realtimeData') ? ContextRealtimeData.fromJson(json['realtimeData'] as Map<String, dynamic>) : null,
...
AudioNode({required this.nodeId,required this.contextId,required this.nodeType,required this.numberOfInputs,required this.numberOfOutputs,required this.channelCount,required this.channelCountMode,required this.channelInterpretation});
...
channelCountMode:  ChannelCountMode.fromJson(json['channelCountMode'] as String),
channelInterpretation:  ChannelInterpretation.fromJson(json['channelInterpretation'] as String),
);
}
...
AudioParam({required this.paramId,required this.nodeId,required this.contextId,required this.paramType,required this.rate,required this.defaultValue,required this.minValue,required this.maxValue});
